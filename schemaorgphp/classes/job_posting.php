...
class JobPosting implements \JsonSerializable {
	 ...
	 *
	 * @var float | float[] | \PriceSpecification | \PriceSpecification[] | \MonetaryAmount | \MonetaryAmount[]
	 */
	public $base_salary;
	...
	public function jsonSerialize() {
		...
		$serialized = so_json_serialize( $this->benefits );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = so_json_serialize( $this->incentives );
		if ( ! empty( $serialized ) ) {
