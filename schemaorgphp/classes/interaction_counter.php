...
class InteractionCounter implements \JsonSerializable {
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->interaction_service );
		if ( ! empty( $serialized ) ) {
			$out['interactionService'] = $serialized;
		}
		
		$serialized = \SchemaOrg\json_serialize( $this->interaction_type );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->user_interaction_count );
		if ( ! empty( $serialized ) ) {
