...
class SportsTeam implements \JsonSerializable {
	...
	/**
	 * With properties from SportsOrganization see : https://schema.org/SportsOrganization
	 */
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->athlete );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->coach );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->sport );
		if ( ! empty( $serialized ) ) {
