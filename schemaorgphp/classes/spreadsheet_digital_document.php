...
class SpreadsheetDigitalDocument implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type = 'SpreadsheetDigitalDocument';
	...
	/**
	 * With properties from DigitalDocument see : https://schema.org/DigitalDocument
	 */
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->has_digital_document_permission );
		if ( ! empty( $serialized ) ) {
