...
class Barcode implements \JsonSerializable {
	...
	/**
	 * With properties from ImageObject see : https://schema.org/ImageObject
	 */
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->exif_data );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->representative_of_page );
		if ( ! empty( $serialized ) ) {
