...
// VideoGameClip see : https://schema.org/VideoGameClip
class VideoGameClip implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type = 'VideoGameClip';
	
	/**
	 * With properties from Clip see : https://schema.org/Clip
	 */
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->clip_number );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->part_of_episode );
		if ( ! empty( $serialized ) ) {
