...
class SiteNavigationElement implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type = 'SiteNavigationElement';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->css_selector );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->xpath );
		if ( ! empty( $serialized ) ) {
