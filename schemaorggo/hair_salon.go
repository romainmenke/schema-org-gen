...
// HairSalon see : https://schema.org/HairSalon
...
func (v HairSalon) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v HairSalon) asMap() (map[string]interface{}, error) {
...
func (v HairSalon) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
