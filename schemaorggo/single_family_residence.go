...
type SingleFamilyResidence struct {
	...
	// With properties from House see : https://schema.org/House
	//
...
func (v SingleFamilyResidence) MarshalJSON() ([]byte, error) {
	type Alias SingleFamilyResidence
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"SingleFamilyResidence\","), b[1:]...), nil
}
