...
type GiveAction struct {
	...
	// With properties from TransferAction see : https://schema.org/TransferAction
	//
...
func (v GiveAction) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v GiveAction) asMap() (map[string]interface{}, error) {
