...
// AutoWash see : https://schema.org/AutoWash
...
func (v AutoWash) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v AutoWash) asMap() (map[string]interface{}, error) {
...
func (v AutoWash) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
