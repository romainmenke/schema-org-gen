...
// HealthClub see : https://schema.org/HealthClub
...
func (v HealthClub) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v HealthClub) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "HealthClub"

	return data, nil
}

func (v HealthClub) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
