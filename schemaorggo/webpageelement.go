...
// WebPageElement see : https://schema.org/WebPageElement
...
func (v WebPageElement) MarshalJSONWithTypeContext() ([]byte, error) {
	v.C = "http://schema.org"
	v.T = "WebPageElement"
...
func (v *WebPageElement) MarshalJSON() ([]byte, error) {
	if v == nil {
