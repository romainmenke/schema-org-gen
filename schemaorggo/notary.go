...
// Notary see : https://schema.org/Notary
type Notary struct {
	typeContext

	// With properties from LegalService see : https://schema.org/LegalService
	//
...
func (v Notary) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v Notary) asMap() (map[string]interface{}, error) {
...
func (v Notary) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
