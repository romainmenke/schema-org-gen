...
// ArtGallery see : https://schema.org/ArtGallery
...
func (v ArtGallery) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v ArtGallery) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "ArtGallery"

	return data, nil
}

func (v ArtGallery) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
