...
// SportingGoodsStore see : https://schema.org/SportingGoodsStore
...
func (v SportingGoodsStore) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v SportingGoodsStore) AsMap() (map[string]interface{}, error) {
	...
	data["@type"] = "SportingGoodsStore"

	return data, nil
}

func (v SportingGoodsStore) MarshalJSON() ([]byte, error) {
	data, err := v.AsMap()
	if err != nil {
		return nil, err
	}
