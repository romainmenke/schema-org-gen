...
// TaxiStand see : https://schema.org/TaxiStand
...
func (v TaxiStand) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v TaxiStand) asMap() (map[string]interface{}, error) {
...
func (v TaxiStand) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
