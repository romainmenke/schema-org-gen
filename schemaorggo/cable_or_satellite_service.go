...
func (v CableOrSatelliteService) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v CableOrSatelliteService) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "CableOrSatelliteService"
