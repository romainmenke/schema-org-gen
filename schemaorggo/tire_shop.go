...
// TireShop see : https://schema.org/TireShop
...
func (v TireShop) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v TireShop) asMap() (map[string]interface{}, error) {
...
func (v TireShop) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
