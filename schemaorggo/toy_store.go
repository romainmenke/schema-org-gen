...
// ToyStore see : https://schema.org/ToyStore
...
func (v ToyStore) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v ToyStore) asMap() (map[string]interface{}, error) {
...
func (v ToyStore) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
