...
func (v AchieveAction) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v AchieveAction) AsMap() (map[string]interface{}, error) {
	...
	data["@type"] = "AchieveAction"

	return data, nil
}

func (v AchieveAction) MarshalJSON() ([]byte, error) {
	data, err := v.AsMap()
	if err != nil {
		return nil, err
	}
