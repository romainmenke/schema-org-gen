...
// ComedyClub see : https://schema.org/ComedyClub
...
func (v ComedyClub) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v ComedyClub) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "ComedyClub"

	return data, nil
}

func (v ComedyClub) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
