...
func (v CurrencyConversionService) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v CurrencyConversionService) AsMap() (map[string]interface{}, error) {
	...
	data["@type"] = "CurrencyConversionService"
