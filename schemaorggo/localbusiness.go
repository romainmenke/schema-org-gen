...
func (v LocalBusiness) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v LocalBusiness) asMap() (map[string]interface{}, error) {
...
func (v LocalBusiness) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
