...
type MusicComposition struct {
	...
	FirstPerformance *Event `json:"firstPerformance,omitempty"` // types : Event

	// IncludedComposition see : https://schema.org/includedComposition
	// Smaller compositions included in this work (e.g. a movement in a symphony).
	IncludedComposition *MusicComposition `json:"includedComposition,omitempty"` // types : MusicComposition

	// IswcCode see : https://schema.org/iswcCode
	// The International Standard Musical Work Code for the composition.
	IswcCode string `json:"iswcCode,omitempty"` // types : Text

	// Lyricist see : https://schema.org/lyricist
	// The person who wrote the words.
	Lyricist *Person `json:"lyricist,omitempty"` // types : Person

	// Lyrics see : https://schema.org/lyrics
	// The words in the song.
	Lyrics *CreativeWork `json:"lyrics,omitempty"` // types : CreativeWork

	// MusicArrangement see : https://schema.org/musicArrangement
	// An arrangement derived from the composition.
	MusicArrangement *MusicComposition `json:"musicArrangement,omitempty"` // types : MusicComposition

	// MusicCompositionForm see : https://schema.org/musicCompositionForm
	// The type of composition (e.g. overture, sonata, symphony, etc.).
	MusicCompositionForm string `json:"musicCompositionForm,omitempty"` // types : Text

	// MusicalKey see : https://schema.org/musicalKey
	// The key, mode, or scale this composition uses.
	MusicalKey string `json:"musicalKey,omitempty"` // types : Text
	...
	RecordedAs *MusicRecording `json:"recordedAs,omitempty"` // types : MusicRecording
