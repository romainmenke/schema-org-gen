...
func (v VideoGameClip) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v VideoGameClip) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "VideoGameClip"

	return data, nil
}

func (v VideoGameClip) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
