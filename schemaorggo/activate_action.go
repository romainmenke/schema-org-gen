...
func (v ActivateAction) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v ActivateAction) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "ActivateAction"

	return data, nil
}

func (v ActivateAction) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
