...
// NightClub see : https://schema.org/NightClub
...
func (v NightClub) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v NightClub) asMap() (map[string]interface{}, error) {
...
func (v NightClub) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
