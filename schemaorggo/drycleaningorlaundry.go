...
// DryCleaningOrLaundry see : https://schema.org/DryCleaningOrLaundry
...
func (v DryCleaningOrLaundry) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v DryCleaningOrLaundry) AsMap() (map[string]interface{}, error) {
	...
	data["@type"] = "DryCleaningOrLaundry"

	return data, nil
}

func (v DryCleaningOrLaundry) MarshalJSON() ([]byte, error) {
	data, err := v.AsMap()
	if err != nil {
		return nil, err
	}
