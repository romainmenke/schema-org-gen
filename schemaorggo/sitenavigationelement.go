...
// SiteNavigationElement see : https://schema.org/SiteNavigationElement
...
func (v SiteNavigationElement) MarshalJSONWithTypeContext() ([]byte, error) {
	v.C = "http://schema.org"
	v.T = "SiteNavigationElement"

	return json.Marshal(v)
}

func (v *SiteNavigationElement) MarshalJSON() ([]byte, error) {
	if v == nil {
