...
// ShoppingCenter see : https://schema.org/ShoppingCenter
...
func (v ShoppingCenter) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v ShoppingCenter) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "ShoppingCenter"

	return data, nil
}

func (v ShoppingCenter) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
