...
// GovernmentOffice see : https://schema.org/GovernmentOffice
...
func (v GovernmentOffice) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v GovernmentOffice) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "GovernmentOffice"

	return data, nil
}

func (v GovernmentOffice) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
