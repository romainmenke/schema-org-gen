...
// DaySpa see : https://schema.org/DaySpa
type DaySpa struct {
	typeContext
...
func (v DaySpa) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v DaySpa) asMap() (map[string]interface{}, error) {
...
func (v DaySpa) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
