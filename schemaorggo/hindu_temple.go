...
// HinduTemple see : https://schema.org/HinduTemple
type HinduTemple struct {
	...
	// With properties from PlaceOfWorship see : https://schema.org/PlaceOfWorship
	//
...
func (v HinduTemple) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v HinduTemple) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "HinduTemple"

	return data, nil
}

func (v HinduTemple) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
