...
// Florist see : https://schema.org/Florist
type Florist struct {
	Store
...
func (v Florist) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v Florist) AsMap() (map[string]interface{}, error) {
...
func (v Florist) MarshalJSON() ([]byte, error) {
	data, err := v.AsMap()
	if err != nil {
		return nil, err
	}
