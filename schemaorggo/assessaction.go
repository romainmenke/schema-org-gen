...
func (v AssessAction) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v AssessAction) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "AssessAction"

	return data, nil
}

func (v AssessAction) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
