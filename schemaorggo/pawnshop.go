...
// PawnShop see : https://schema.org/PawnShop
...
func (v PawnShop) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v PawnShop) asMap() (map[string]interface{}, error) {
...
func (v PawnShop) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
