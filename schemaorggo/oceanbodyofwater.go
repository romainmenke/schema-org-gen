...
// OceanBodyOfWater see : https://schema.org/OceanBodyOfWater
type OceanBodyOfWater struct {
	...
	BranchCode string `json:"branchCode,omitempty"` // types : Text
	...
	ContainedInPlace *Place `json:"containedInPlace,omitempty"` // types : Place
	...
	ContainsPlace *Place `json:"containsPlace,omitempty"` // types : Place
	...
	Geo interface{} `json:"geo,omitempty"` // types : GeoCoordinates GeoShape

	// GeospatiallyContains see : https://schema.org/geospatiallyContains
	...
	GeospatiallyContains interface{} `json:"geospatiallyContains,omitempty"` // types : GeospatialGeometry Place

	// GeospatiallyCoveredBy see : https://schema.org/geospatiallyCoveredBy
	...
	GeospatiallyCoveredBy interface{} `json:"geospatiallyCoveredBy,omitempty"` // types : GeospatialGeometry Place

	// GeospatiallyCovers see : https://schema.org/geospatiallyCovers
	...
	GeospatiallyCovers interface{} `json:"geospatiallyCovers,omitempty"` // types : GeospatialGeometry Place

	// GeospatiallyCrosses see : https://schema.org/geospatiallyCrosses
	...
	GeospatiallyCrosses interface{} `json:"geospatiallyCrosses,omitempty"` // types : GeospatialGeometry Place

	// GeospatiallyDisjoint see : https://schema.org/geospatiallyDisjoint
	...
	GeospatiallyDisjoint interface{} `json:"geospatiallyDisjoint,omitempty"` // types : GeospatialGeometry Place

	// GeospatiallyEquals see : https://schema.org/geospatiallyEquals
	...
	GeospatiallyEquals interface{} `json:"geospatiallyEquals,omitempty"` // types : GeospatialGeometry Place

	// GeospatiallyIntersects see : https://schema.org/geospatiallyIntersects
	...
	GeospatiallyIntersects interface{} `json:"geospatiallyIntersects,omitempty"` // types : GeospatialGeometry Place

	// GeospatiallyOverlaps see : https://schema.org/geospatiallyOverlaps
	...
	GeospatiallyOverlaps interface{} `json:"geospatiallyOverlaps,omitempty"` // types : GeospatialGeometry Place

	// GeospatiallyTouches see : https://schema.org/geospatiallyTouches
	...
	GeospatiallyTouches interface{} `json:"geospatiallyTouches,omitempty"` // types : GeospatialGeometry Place

	// GeospatiallyWithin see : https://schema.org/geospatiallyWithin
	...
	GeospatiallyWithin interface{} `json:"geospatiallyWithin,omitempty"` // types : GeospatialGeometry Place
	...
	HasMap interface{} `json:"hasMap,omitempty"` // types : Map URL
	...
	OpeningHoursSpecification *OpeningHoursSpecification `json:"openingHoursSpecification,omitempty"` // types : OpeningHoursSpecification

	// Photo see : https://schema.org/photo
	// A photograph of this place. Supersedes photos (see: https://schema.org/photos).
	Photo interface{} `json:"photo,omitempty"` // types : ImageObject Photograph
	...
	PublicAccess bool `json:"publicAccess,omitempty"` // types : Boolean
	...
	SmokingAllowed bool `json:"smokingAllowed,omitempty"` // types : Boolean
	...
	SpecialOpeningHoursSpecification *OpeningHoursSpecification `json:"specialOpeningHoursSpecification,omitempty"` // types : OpeningHoursSpecification
...
func (v OceanBodyOfWater) MarshalJSONWithTypeContext() ([]byte, error) {
	v.C = "http://schema.org"
	v.T = "OceanBodyOfWater"

	return json.Marshal(v)
}

func (v *OceanBodyOfWater) MarshalJSON() ([]byte, error) {
	if v == nil {
