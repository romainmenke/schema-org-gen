...
// BusStop see : https://schema.org/BusStop
type BusStop struct {
	CivicStructure
...
func (v BusStop) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v BusStop) asMap() (map[string]interface{}, error) {
...
func (v BusStop) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
