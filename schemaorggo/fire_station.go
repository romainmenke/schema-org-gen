...
// FireStation see : https://schema.org/FireStation
...
func (v FireStation) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v FireStation) asMap() (map[string]interface{}, error) {
...
func (v FireStation) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
