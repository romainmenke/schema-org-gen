...
// CreateAction see : https://schema.org/CreateAction
...
func (v CreateAction) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v CreateAction) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "CreateAction"

	return data, nil
}

func (v CreateAction) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
