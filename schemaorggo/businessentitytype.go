...
func (v BusinessEntityType) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v BusinessEntityType) asMap() (map[string]interface{}, error) {
