...
type DataFeed struct {
	...
	// Catalog see : https://schema.org/catalog
	...
	// types : Text Thing DataFeedItem
	DataFeedElement []interface{} `json:"dataFeedElement,omitempty"`

	// DatasetTimeInterval see : https://schema.org/datasetTimeInterval
	...
	// IncludedDataCatalog see : https://schema.org/includedDataCatalog
	...
	// Spatial see : https://schema.org/spatial
	...
	// Temporal see : https://schema.org/temporal
	// The range of temporal applicability of a dataset, e.g. for a 2011 census dataset, the year 2011 (in ISO 8601 time interval format).
	// types : DateTime
...
func (v DataFeed) MarshalJSON() ([]byte, error) {
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"DataFeed\","), b[1:]...), nil
}
