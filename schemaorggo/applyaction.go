...
func (v ApplyAction) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v ApplyAction) AsMap() (map[string]interface{}, error) {
	...
	data["@type"] = "ApplyAction"

	return data, nil
}

func (v ApplyAction) MarshalJSON() ([]byte, error) {
	data, err := v.AsMap()
	if err != nil {
		return nil, err
	}
