...
func (v WholesaleStore) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v WholesaleStore) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "WholesaleStore"

	return data, nil
}

func (v WholesaleStore) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
