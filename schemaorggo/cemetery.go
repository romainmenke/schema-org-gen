...
// Cemetery see : https://schema.org/Cemetery
...
func (v Cemetery) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v Cemetery) asMap() (map[string]interface{}, error) {
...
func (v Cemetery) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
