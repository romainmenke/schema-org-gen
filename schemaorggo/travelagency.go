...
// TravelAgency see : https://schema.org/TravelAgency
...
func (v TravelAgency) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v TravelAgency) AsMap() (map[string]interface{}, error) {
...
func (v TravelAgency) MarshalJSON() ([]byte, error) {
	data, err := v.AsMap()
	if err != nil {
		return nil, err
	}
