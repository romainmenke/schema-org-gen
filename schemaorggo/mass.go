...
type Mass struct {
	...
	// With properties from Quantity see : https://schema.org/Quantity
	//
...
func (v Mass) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v Mass) asMap() (map[string]interface{}, error) {
