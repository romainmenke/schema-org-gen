...
type DisagreeAction struct {
	...
	// With properties from ReactAction see : https://schema.org/ReactAction
	//
...
func (v DisagreeAction) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v DisagreeAction) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "DisagreeAction"

	return data, nil
}

func (v DisagreeAction) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
