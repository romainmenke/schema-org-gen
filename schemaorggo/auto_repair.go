...
// AutoRepair see : https://schema.org/AutoRepair
...
func (v AutoRepair) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v AutoRepair) asMap() (map[string]interface{}, error) {
...
func (v AutoRepair) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
