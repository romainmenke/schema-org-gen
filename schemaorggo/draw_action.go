...
func (v DrawAction) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v DrawAction) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "DrawAction"

	return data, nil
}

func (v DrawAction) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
