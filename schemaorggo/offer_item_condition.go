...
func (v OfferItemCondition) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v OfferItemCondition) asMap() (map[string]interface{}, error) {
