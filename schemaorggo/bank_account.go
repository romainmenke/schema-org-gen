...
type BankAccount struct {
	...
	// AccountMinimumInflow see : https://pending.schema.org/accountMinimumInflow
	// A minimum amount that has to be paid in every month.
	// types : MonetaryAmount
	AccountMinimumInflow []*MonetaryAmount `json:"accountMinimumInflow,omitempty"`

	// AccountOverdraftLimit see : https://pending.schema.org/accountOverdraftLimit
	...
	// BankAccountType see : https://pending.schema.org/bankAccountType
