...
// GatedResidenceCommunity see : https://schema.org/GatedResidenceCommunity
...
func (v GatedResidenceCommunity) MarshalJSONWithTypeContext() ([]byte, error) {
	v.C = "http://schema.org"
	v.T = "GatedResidenceCommunity"
