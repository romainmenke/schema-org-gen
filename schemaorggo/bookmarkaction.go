...
func (v BookmarkAction) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v BookmarkAction) AsMap() (map[string]interface{}, error) {
	...
	data["@type"] = "BookmarkAction"

	return data, nil
}

func (v BookmarkAction) MarshalJSON() ([]byte, error) {
	data, err := v.AsMap()
	if err != nil {
		return nil, err
	}
