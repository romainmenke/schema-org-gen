...
// SportsClub see : https://schema.org/SportsClub
...
func (v SportsClub) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v SportsClub) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "SportsClub"

	return data, nil
}

func (v SportsClub) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
