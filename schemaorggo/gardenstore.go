...
// GardenStore see : https://schema.org/GardenStore
...
func (v GardenStore) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v GardenStore) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "GardenStore"

	return data, nil
}

func (v GardenStore) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
