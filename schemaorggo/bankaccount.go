...
type BankAccount struct {
	...
	AccountMinimumInflow *MonetaryAmount `json:"accountMinimumInflow,omitempty"` // types : MonetaryAmount
	...
	AccountOverdraftLimit *MonetaryAmount `json:"accountOverdraftLimit,omitempty"` // types : MonetaryAmount

	// BankAccountType see : http://pending.schema.org/bankAccountType
	// The type of a bank account.
	BankAccountType string `json:"bankAccountType,omitempty"` // types : Text URL
