...
func (v FastFoodRestaurant) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v FastFoodRestaurant) asMap() (map[string]interface{}, error) {
