...
// DeactivateAction see : https://schema.org/DeactivateAction
type DeactivateAction struct {
	...
	// With properties from ControlAction see : https://schema.org/ControlAction
	//
...
func (v DeactivateAction) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v DeactivateAction) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "DeactivateAction"

	return data, nil
}

func (v DeactivateAction) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
