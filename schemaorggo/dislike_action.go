...
func (v DislikeAction) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v DislikeAction) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "DislikeAction"

	return data, nil
}

func (v DislikeAction) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
