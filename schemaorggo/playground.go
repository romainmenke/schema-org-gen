...
// Playground see : https://schema.org/Playground
...
func (v Playground) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v Playground) asMap() (map[string]interface{}, error) {
...
func (v Playground) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
