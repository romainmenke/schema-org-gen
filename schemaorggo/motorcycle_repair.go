...
// MotorcycleRepair see : https://schema.org/MotorcycleRepair
...
func (v MotorcycleRepair) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v MotorcycleRepair) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "MotorcycleRepair"

	return data, nil
}

func (v MotorcycleRepair) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
