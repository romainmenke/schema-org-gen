...
func (v InteractAction) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v InteractAction) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "InteractAction"

	return data, nil
}

func (v InteractAction) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
