...
// AutoRental see : https://schema.org/AutoRental
...
func (v AutoRental) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v AutoRental) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "AutoRental"

	return data, nil
}

func (v AutoRental) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
