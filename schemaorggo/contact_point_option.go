...
func (v ContactPointOption) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v ContactPointOption) asMap() (map[string]interface{}, error) {
