...
func (v MarryAction) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v MarryAction) AsMap() (map[string]interface{}, error) {
	...
	data["@type"] = "MarryAction"

	return data, nil
}

func (v MarryAction) MarshalJSON() ([]byte, error) {
	data, err := v.AsMap()
	if err != nil {
		return nil, err
	}
