...
// SelfStorage see : https://schema.org/SelfStorage
...
func (v SelfStorage) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v SelfStorage) asMap() (map[string]interface{}, error) {
...
func (v SelfStorage) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
