...
// AmusementPark see : https://schema.org/AmusementPark
type AmusementPark struct {
	typeContext

	// With properties from EntertainmentBusiness see : https://schema.org/EntertainmentBusiness
	//
...
func (v AmusementPark) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v AmusementPark) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "AmusementPark"

	return data, nil
}

func (v AmusementPark) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
