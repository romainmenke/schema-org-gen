...
func (v LegalService) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v LegalService) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "LegalService"

	return data, nil
}

func (v LegalService) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
