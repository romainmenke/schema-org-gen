...
// GovernmentOrganization see : https://schema.org/GovernmentOrganization
...
func (v GovernmentOrganization) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v GovernmentOrganization) asMap() (map[string]interface{}, error) {
...
func (v GovernmentOrganization) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
