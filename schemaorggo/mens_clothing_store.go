...
// MensClothingStore see : https://schema.org/MensClothingStore
...
func (v MensClothingStore) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v MensClothingStore) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "MensClothingStore"

	return data, nil
}

func (v MensClothingStore) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
