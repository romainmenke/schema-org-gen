...
// ShoeStore see : https://schema.org/ShoeStore
...
func (v ShoeStore) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v ShoeStore) asMap() (map[string]interface{}, error) {
...
func (v ShoeStore) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
