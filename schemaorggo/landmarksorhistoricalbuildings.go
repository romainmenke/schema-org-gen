...
// LandmarksOrHistoricalBuildings see : https://schema.org/LandmarksOrHistoricalBuildings
...
func (v LandmarksOrHistoricalBuildings) MarshalJSONWithTypeContext() ([]byte, error) {
	v.C = "http://schema.org"
	v.T = "LandmarksOrHistoricalBuildings"

	return json.Marshal(v)
}

func (v *LandmarksOrHistoricalBuildings) MarshalJSON() ([]byte, error) {
	if v == nil {
