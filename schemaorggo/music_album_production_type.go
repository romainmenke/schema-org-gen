...
func (v MusicAlbumProductionType) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v MusicAlbumProductionType) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "MusicAlbumProductionType"
