...
// OutletStore see : https://schema.org/OutletStore
...
func (v OutletStore) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v OutletStore) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "OutletStore"

	return data, nil
}

func (v OutletStore) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
