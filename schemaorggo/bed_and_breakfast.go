...
func (v BedAndBreakfast) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v BedAndBreakfast) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "BedAndBreakfast"

	return data, nil
}

func (v BedAndBreakfast) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
