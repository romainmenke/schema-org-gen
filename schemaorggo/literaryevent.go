...
// LiteraryEvent see : https://schema.org/LiteraryEvent
type LiteraryEvent struct {
	...
	Attendee interface{} `json:"attendee,omitempty"` // types : Organization Person
	...
	Organizer interface{} `json:"organizer,omitempty"` // types : Organization Person
	...
	Performer interface{} `json:"performer,omitempty"` // types : Organization Person
...
func (v LiteraryEvent) MarshalJSONWithTypeContext() ([]byte, error) {
	v.C = "http://schema.org"
	v.T = "LiteraryEvent"
...
func (v *LiteraryEvent) MarshalJSON() ([]byte, error) {
	if v == nil {
