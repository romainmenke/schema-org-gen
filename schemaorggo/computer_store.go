...
// ComputerStore see : https://schema.org/ComputerStore
...
func (v ComputerStore) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v ComputerStore) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "ComputerStore"

	return data, nil
}

func (v ComputerStore) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
