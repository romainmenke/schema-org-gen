...
func (v FoodEstablishment) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v FoodEstablishment) asMap() (map[string]interface{}, error) {
...
func (v FoodEstablishment) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
