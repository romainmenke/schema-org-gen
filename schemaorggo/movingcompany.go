...
func (v MovingCompany) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v MovingCompany) AsMap() (map[string]interface{}, error) {
	...
	data["@type"] = "MovingCompany"

	return data, nil
}

func (v MovingCompany) MarshalJSON() ([]byte, error) {
	data, err := v.AsMap()
	if err != nil {
		return nil, err
	}
