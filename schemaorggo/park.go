...
// Park see : https://schema.org/Park
type Park struct {
	CivicStructure
...
func (v Park) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v Park) AsMap() (map[string]interface{}, error) {
...
func (v Park) MarshalJSON() ([]byte, error) {
	data, err := v.AsMap()
	if err != nil {
		return nil, err
	}
