...
// Synagogue see : https://schema.org/Synagogue
...
func (v Synagogue) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v Synagogue) asMap() (map[string]interface{}, error) {
...
func (v Synagogue) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
