...
type ProgramMembership struct {
	...
	HostingOrganization *Organization `json:"hostingOrganization,omitempty"` // types : Organization
	...
	MembershipNumber string `json:"membershipNumber,omitempty"` // types : Text

	// ProgramName see : https://schema.org/programName
	// The program providing the membership.
	ProgramName string `json:"programName,omitempty"` // types : Text
