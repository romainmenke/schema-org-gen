...
// ClothingStore see : https://schema.org/ClothingStore
...
func (v ClothingStore) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v ClothingStore) AsMap() (map[string]interface{}, error) {
	...
	data["@type"] = "ClothingStore"

	return data, nil
}

func (v ClothingStore) MarshalJSON() ([]byte, error) {
	data, err := v.AsMap()
	if err != nil {
		return nil, err
	}
