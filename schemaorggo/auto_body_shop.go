...
func (v AutoBodyShop) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v AutoBodyShop) asMap() (map[string]interface{}, error) {
...
func (v AutoBodyShop) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
