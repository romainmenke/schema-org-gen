...
type EmailMessage struct {
	...
	// With properties from Message see : https://schema.org/Message
	//
...
func (v EmailMessage) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v EmailMessage) asMap() (map[string]interface{}, error) {
