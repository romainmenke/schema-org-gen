...
func (v RealEstateAgent) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v RealEstateAgent) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "RealEstateAgent"

	return data, nil
}

func (v RealEstateAgent) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
