...
type Offer struct {
	...
	AddOn *Offer `json:"addOn,omitempty"` // types : Offer

	// AdvanceBookingRequirement see : https://schema.org/advanceBookingRequirement
	// The amount of time that is required between accepting the offer and the actual usage of the resource or service.
	AdvanceBookingRequirement *QuantitativeValue `json:"advanceBookingRequirement,omitempty"` // types : QuantitativeValue
	...
	Availability *ItemAvailability `json:"availability,omitempty"` // types : ItemAvailability

	// AvailabilityEnds see : https://schema.org/availabilityEnds
	// The end of the availability of the product or service included in the offer.
	AvailabilityEnds DateTime `json:"availabilityEnds,omitempty"` // types : DateTime

	// AvailabilityStarts see : https://schema.org/availabilityStarts
	// The beginning of the availability of the product or service included in the offer.
	AvailabilityStarts DateTime `json:"availabilityStarts,omitempty"` // types : DateTime

	// AvailableAtOrFrom see : https://schema.org/availableAtOrFrom
	// The place(s) from which the offer can be obtained (e.g. store locations).
	AvailableAtOrFrom *Place `json:"availableAtOrFrom,omitempty"` // types : Place

	// AvailableDeliveryMethod see : https://schema.org/availableDeliveryMethod
	// The delivery method(s) available for this offer.
	AvailableDeliveryMethod *DeliveryMethod `json:"availableDeliveryMethod,omitempty"` // types : DeliveryMethod

	// BusinessFunction see : https://schema.org/businessFunction
	// The business function (e.g. sell, lease, repair, dispose) of the offer or component of a bundle (TypeAndQuantityNode). The default is http://purl.org/goodrelations/v1#Sell.
	BusinessFunction *BusinessFunction `json:"businessFunction,omitempty"` // types : BusinessFunction
	...
	DeliveryLeadTime *QuantitativeValue `json:"deliveryLeadTime,omitempty"` // types : QuantitativeValue

	// EligibleCustomerType see : https://schema.org/eligibleCustomerType
	// The type(s) of customers for which the given offer is valid.
	EligibleCustomerType *BusinessEntityType `json:"eligibleCustomerType,omitempty"` // types : BusinessEntityType

	// EligibleDuration see : https://schema.org/eligibleDuration
	// The duration for which the given offer is valid.
	EligibleDuration *QuantitativeValue `json:"eligibleDuration,omitempty"` // types : QuantitativeValue
	...
	IncludesObject *TypeAndQuantityNode `json:"includesObject,omitempty"` // types : TypeAndQuantityNode
	...
	InventoryLevel *QuantitativeValue `json:"inventoryLevel,omitempty"` // types : QuantitativeValue
	...
	PriceValidUntil Date `json:"priceValidUntil,omitempty"` // types : Date
	...
	Warranty *WarrantyPromise `json:"warranty,omitempty"` // types : WarrantyPromise
