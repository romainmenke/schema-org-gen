...
func (v AdministrativeArea) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v AdministrativeArea) AsMap() (map[string]interface{}, error) {
