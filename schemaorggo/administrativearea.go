...
// AdministrativeArea see : https://schema.org/AdministrativeArea
...
func (v AdministrativeArea) MarshalJSONWithTypeContext() ([]byte, error) {
	v.C = "http://schema.org"
	v.T = "AdministrativeArea"

	return json.Marshal(v)
}

func (v *AdministrativeArea) MarshalJSON() ([]byte, error) {
	if v == nil {
