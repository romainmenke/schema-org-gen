...
func (v LikeAction) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v LikeAction) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "LikeAction"

	return data, nil
}

func (v LikeAction) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
