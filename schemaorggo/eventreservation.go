...
// EventReservation see : https://schema.org/EventReservation
type EventReservation struct {
	...
	BookingTime DateTime `json:"bookingTime,omitempty"` // types : DateTime
	...
	ModifiedTime DateTime `json:"modifiedTime,omitempty"` // types : DateTime
	...
	ProgramMembershipUsed *ProgramMembership `json:"programMembershipUsed,omitempty"` // types : ProgramMembership
	...
	ReservationFor *Thing `json:"reservationFor,omitempty"` // types : Thing

	// ReservationId see : https://schema.org/reservationId
	// A unique identifier for the reservation.
	ReservationId string `json:"reservationId,omitempty"` // types : Text

	// ReservationStatus see : https://schema.org/reservationStatus
	// The current status of the reservation.
	ReservationStatus *ReservationStatusType `json:"reservationStatus,omitempty"` // types : ReservationStatusType

	// ReservedTicket see : https://schema.org/reservedTicket
	// A ticket associated with the reservation.
	ReservedTicket *Ticket `json:"reservedTicket,omitempty"` // types : Ticket
...
func (v EventReservation) MarshalJSONWithTypeContext() ([]byte, error) {
	v.C = "http://schema.org"
	v.T = "EventReservation"

	return json.Marshal(v)
}

func (v *EventReservation) MarshalJSON() ([]byte, error) {
	if v == nil {
