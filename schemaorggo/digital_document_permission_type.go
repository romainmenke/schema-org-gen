...
func (v DigitalDocumentPermissionType) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v DigitalDocumentPermissionType) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "DigitalDocumentPermissionType"
