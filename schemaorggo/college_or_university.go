...
type CollegeOrUniversity struct {
	...
	// With properties from EducationalOrganization see : https://schema.org/EducationalOrganization
	//
...
func (v CollegeOrUniversity) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v CollegeOrUniversity) asMap() (map[string]interface{}, error) {
