...
// EventVenue see : https://schema.org/EventVenue
...
func (v EventVenue) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v EventVenue) AsMap() (map[string]interface{}, error) {
	...
	data["@type"] = "EventVenue"

	return data, nil
}

func (v EventVenue) MarshalJSON() ([]byte, error) {
	data, err := v.AsMap()
	if err != nil {
		return nil, err
	}
