...
// AutomotiveBusiness see : https://schema.org/AutomotiveBusiness
...
func (v AutomotiveBusiness) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v AutomotiveBusiness) asMap() (map[string]interface{}, error) {
...
func (v AutomotiveBusiness) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
