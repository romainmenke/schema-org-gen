...
func (v PhotographAction) IntoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v PhotographAction) AsMap() (map[string]interface{}, error) {
	...
	data["@type"] = "PhotographAction"

	return data, nil
}

func (v PhotographAction) MarshalJSON() ([]byte, error) {
	data, err := v.AsMap()
	if err != nil {
		return nil, err
	}
