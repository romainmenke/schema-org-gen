...
// ProfessionalService see : https://schema.org/ProfessionalService
...
func (v ProfessionalService) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v ProfessionalService) asMap() (map[string]interface{}, error) {
...
func (v ProfessionalService) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
