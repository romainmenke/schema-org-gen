...
type Vehicle struct {
	...
	BodyType interface{} `json:"bodyType,omitempty"` // types : QualitativeValue Text URL
	...
	DriveWheelConfiguration interface{} `json:"driveWheelConfiguration,omitempty"` // types : DriveWheelConfigurationValue Text
	...
	MeetsEmissionStandard interface{} `json:"meetsEmissionStandard,omitempty"` // types : QualitativeValue Text URL
	...
	NumberOfAirbags interface{} `json:"numberOfAirbags,omitempty"` // types : Number Text

	// NumberOfAxles see : https://schema.org/numberOfAxles
	// The number of axles.
	//
	// Typical unit code(s): C62
	NumberOfAxles interface{} `json:"numberOfAxles,omitempty"` // types : Number QuantitativeValue

	// NumberOfDoors see : https://schema.org/numberOfDoors
	// The number of doors.
	//
	// Typical unit code(s): C62
	NumberOfDoors interface{} `json:"numberOfDoors,omitempty"` // types : Number QuantitativeValue

	// NumberOfForwardGears see : https://schema.org/numberOfForwardGears
	// The total number of forward gears available for the transmission system of the vehicle.
	//
	// Typical unit code(s): C62
	NumberOfForwardGears interface{} `json:"numberOfForwardGears,omitempty"` // types : Number QuantitativeValue

	// NumberOfPreviousOwners see : https://schema.org/numberOfPreviousOwners
	// The number of owners of the vehicle, including the current one.
	//
	// Typical unit code(s): C62
	NumberOfPreviousOwners interface{} `json:"numberOfPreviousOwners,omitempty"` // types : Number QuantitativeValue
	...
	SeatingCapacity interface{} `json:"seatingCapacity,omitempty"` // types : Number QuantitativeValue
	...
	//
	// Typical unit code(s): C62 for persons.
	VehicleSeatingCapacity interface{} `json:"vehicleSeatingCapacity,omitempty"` // types : Number QuantitativeValue

	// VehicleSpecialUsage see : https://auto.schema.org/vehicleSpecialUsage
	// Indicates whether the vehicle has been used for special purposes, like commercial rental, driving school, or as a taxi. The legislation in many countries requires this information to be revealed when offering a car for sale.
	VehicleSpecialUsage interface{} `json:"vehicleSpecialUsage,omitempty"` // types : CarUsageType Text

	// VehicleTransmission see : https://schema.org/vehicleTransmission
	// The type of component used for transmitting the power from a rotating power source to the wheels or other relevant component(s) ("gearbox" for cars).
	VehicleTransmission interface{} `json:"vehicleTransmission,omitempty"` // types : QualitativeValue Text URL
