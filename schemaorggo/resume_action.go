...
func (v ResumeAction) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v ResumeAction) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "ResumeAction"

	return data, nil
}

func (v ResumeAction) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
