...
// AutoDealer see : https://schema.org/AutoDealer
...
func (v AutoDealer) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v AutoDealer) asMap() (map[string]interface{}, error) {
...
func (v AutoDealer) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
