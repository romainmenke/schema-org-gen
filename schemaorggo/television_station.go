...
// TelevisionStation see : https://schema.org/TelevisionStation
...
func (v TelevisionStation) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v TelevisionStation) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "TelevisionStation"

	return data, nil
}

func (v TelevisionStation) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
