...
// Beach see : https://schema.org/Beach
type Beach struct {
	typeContext
...
func (v Beach) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v Beach) asMap() (map[string]interface{}, error) {
...
func (v Beach) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
