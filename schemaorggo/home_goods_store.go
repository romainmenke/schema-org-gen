...
// HomeGoodsStore see : https://schema.org/HomeGoodsStore
...
func (v HomeGoodsStore) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v HomeGoodsStore) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "HomeGoodsStore"

	return data, nil
}

func (v HomeGoodsStore) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
