...
// RadioStation see : https://schema.org/RadioStation
...
func (v RadioStation) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v RadioStation) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "RadioStation"

	return data, nil
}

func (v RadioStation) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
