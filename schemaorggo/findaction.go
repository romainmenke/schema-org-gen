...
func (v FindAction) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v FindAction) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "FindAction"

	return data, nil
}

func (v FindAction) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
