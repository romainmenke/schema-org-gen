...
// Courthouse see : https://schema.org/Courthouse
...
func (v Courthouse) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v Courthouse) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "Courthouse"

	return data, nil
}

func (v Courthouse) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
