...
// SeaBodyOfWater see : https://schema.org/SeaBodyOfWater
...
func (v SeaBodyOfWater) MarshalJSONWithTypeContext() ([]byte, error) {
	v.C = "http://schema.org"
	v.T = "SeaBodyOfWater"
...
func (v *SeaBodyOfWater) MarshalJSON() ([]byte, error) {
	if v == nil {
