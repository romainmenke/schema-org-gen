...
// HealthAndBeautyBusiness see : https://schema.org/HealthAndBeautyBusiness
...
func (v HealthAndBeautyBusiness) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v HealthAndBeautyBusiness) asMap() (map[string]interface{}, error) {
...
func (v HealthAndBeautyBusiness) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
