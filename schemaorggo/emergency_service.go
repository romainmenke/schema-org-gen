...
// EmergencyService see : https://schema.org/EmergencyService
...
func (v EmergencyService) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v EmergencyService) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "EmergencyService"

	return data, nil
}

func (v EmergencyService) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
