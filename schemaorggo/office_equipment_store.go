...
func (v OfficeEquipmentStore) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v OfficeEquipmentStore) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "OfficeEquipmentStore"

	return data, nil
}

func (v OfficeEquipmentStore) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
