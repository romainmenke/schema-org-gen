...
type QualitativeValue struct {
	...
	Equal *QualitativeValue `json:"equal,omitempty"` // types : QualitativeValue

	// Greater see : https://schema.org/greater
	// This ordering relation for qualitative values indicates that the subject is greater than the object.
	Greater *QualitativeValue `json:"greater,omitempty"` // types : QualitativeValue

	// GreaterOrEqual see : https://schema.org/greaterOrEqual
	// This ordering relation for qualitative values indicates that the subject is greater than or equal to the object.
	GreaterOrEqual *QualitativeValue `json:"greaterOrEqual,omitempty"` // types : QualitativeValue

	// Lesser see : https://schema.org/lesser
	// This ordering relation for qualitative values indicates that the subject is lesser than the object.
	Lesser *QualitativeValue `json:"lesser,omitempty"` // types : QualitativeValue

	// LesserOrEqual see : https://schema.org/lesserOrEqual
	// This ordering relation for qualitative values indicates that the subject is lesser than or equal to the object.
	LesserOrEqual *QualitativeValue `json:"lesserOrEqual,omitempty"` // types : QualitativeValue

	// NonEqual see : https://schema.org/nonEqual
	// This ordering relation for qualitative values indicates that the subject is not equal to the object.
	NonEqual *QualitativeValue `json:"nonEqual,omitempty"` // types : QualitativeValue
...
func (v QualitativeValue) MarshalJSONWithTypeContext() ([]byte, error) {
	v.C = "http://schema.org"
