...
func (v FilmAction) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v FilmAction) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "FilmAction"

	return data, nil
}

func (v FilmAction) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
