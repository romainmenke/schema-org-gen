...
func (v MusicReleaseFormatType) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v MusicReleaseFormatType) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "MusicReleaseFormatType"
