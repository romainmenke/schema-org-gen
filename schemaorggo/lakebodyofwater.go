...
// LakeBodyOfWater see : https://schema.org/LakeBodyOfWater
...
func (v LakeBodyOfWater) MarshalJSONWithTypeContext() ([]byte, error) {
	v.C = "http://schema.org"
	v.T = "LakeBodyOfWater"
...
func (v *LakeBodyOfWater) MarshalJSON() ([]byte, error) {
	if v == nil {
