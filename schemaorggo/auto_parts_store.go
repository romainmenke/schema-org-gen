...
// AutoPartsStore see : https://schema.org/AutoPartsStore
...
func (v AutoPartsStore) intoMap(intop *map[string]interface{}) error {
	if intop == nil {
		return nil
	}
...
func (v AutoPartsStore) asMap() (map[string]interface{}, error) {
	...
	data["@type"] = "AutoPartsStore"

	return data, nil
}

func (v AutoPartsStore) MarshalJSON() ([]byte, error) {
	data, err := v.asMap()
	if err != nil {
		return nil, err
	}
