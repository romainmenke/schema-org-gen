...
class RsvpAction implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'RsvpAction';

	/**
	 * With properties from InformAction see : https://schema.org/InformAction
	 */
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->additional_number_of_guests );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->rsvp_response );
		if ( ! empty( $serialized ) ) {
