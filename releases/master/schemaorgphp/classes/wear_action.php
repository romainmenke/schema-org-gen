...
class WearAction implements \JsonSerializable {
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->action_accessibility_requirement );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->expects_acceptance_of );
		if ( ! empty( $serialized ) ) {
