...
class HowToSupply implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'HowToSupply';

	/**
	 * With properties from HowToItem see : https://schema.org/HowToItem
	 */
	 ...
	 *
	 * @var string | string[] | float | float[] | \QuantitativeValue | \QuantitativeValue[]
	 */
