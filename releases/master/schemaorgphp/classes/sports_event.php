...
class SportsEvent implements \JsonSerializable {
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->away_team );
		if ( ! empty( $serialized ) ) {
			$out['awayTeam'] = $serialized;
		}

		$serialized = \SchemaOrg\json_serialize( $this->competitor );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->home_team );
		if ( ! empty( $serialized ) ) {
