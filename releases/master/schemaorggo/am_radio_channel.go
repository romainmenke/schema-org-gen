...
// AMRadioChannel see : https://schema.org/AMRadioChannel
...
func (v AMRadioChannel) MarshalJSON() ([]byte, error) {
	type Alias AMRadioChannel
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"AMRadioChannel\","), b[1:]...), nil
}
