...
// PreOrderAction see : https://schema.org/PreOrderAction
...
func (v PreOrderAction) MarshalJSON() ([]byte, error) {
	type Alias PreOrderAction
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"PreOrderAction\","), b[1:]...), nil
}
