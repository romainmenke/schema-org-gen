...
// ImageGallery see : https://schema.org/ImageGallery
type ImageGallery struct {

	// With properties from CollectionPage see : https://schema.org/CollectionPage
	//
	...
	// SignificantLinks see : https://schema.org/significantLinks
	// The most significant URLs on the page. Typically, these are the non-navigation links that are clicked on the most.
	// types : URL
	SignificantLinks []string `json:"significantLinks,omitempty"`
	...
	// Speakable see : https://schema.org/speakable
...
func (v ImageGallery) MarshalJSON() ([]byte, error) {
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"ImageGallery\","), b[1:]...), nil
}
