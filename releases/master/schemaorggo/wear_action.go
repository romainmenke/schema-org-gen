...
type WearAction struct {
	...
	// With properties from UseAction see : https://schema.org/UseAction
	//

	// With properties from ConsumeAction see : https://schema.org/ConsumeAction
	//
	...
	// ActionAccessibilityRequirement see : https://schema.org/actionAccessibilityRequirement
	// A set of requirements that a must be fulfilled in order to perform an Action. If more than one value is specied, fulfilling one set of requirements will allow the Action to be performed.
	// types : ActionAccessSpecification
	ActionAccessibilityRequirement []*ActionAccessSpecification `json:"actionAccessibilityRequirement,omitempty"`
...
func (v WearAction) MarshalJSON() ([]byte, error) {
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"WearAction\","), b[1:]...), nil
}
