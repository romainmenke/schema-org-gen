...
// CheckoutPage see : https://schema.org/CheckoutPage
...
func (v CheckoutPage) MarshalJSON() ([]byte, error) {
	type Alias CheckoutPage
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"CheckoutPage\","), b[1:]...), nil
}
