...
// WorkersUnion see : https://schema.org/WorkersUnion
...
func (v WorkersUnion) MarshalJSON() ([]byte, error) {
	type Alias WorkersUnion
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"WorkersUnion\","), b[1:]...), nil
}
