...
func (v EmployerAggregateRating) MarshalJSON() ([]byte, error) {
	type Alias EmployerAggregateRating
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"EmployerAggregateRating\","), b[1:]...), nil
}
