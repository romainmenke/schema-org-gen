...
func (v QuantitativeValueDistribution) MarshalJSON() ([]byte, error) {
	type Alias QuantitativeValueDistribution
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"QuantitativeValueDistribution\","), b[1:]...), nil
}
