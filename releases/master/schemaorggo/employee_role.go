...
type EmployeeRole struct {
	...
	// NamedPosition see : https://schema.org/namedPosition
	// A position played, performed or filled by a person or organization, as part of an organization. For example, an athlete in a SportsTeam might play in the position named &#39;Quarterback&#39;.
	// types : Text URL
	NamedPosition []string `json:"namedPosition,omitempty"`
...
func (v EmployeeRole) MarshalJSON() ([]byte, error) {
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"EmployeeRole\","), b[1:]...), nil
}
