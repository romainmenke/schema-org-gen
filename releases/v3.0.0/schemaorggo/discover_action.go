...
// DiscoverAction see : https://schema.org/DiscoverAction
type DiscoverAction struct {

	// With properties from FindAction see : https://schema.org/FindAction
	//
...
func (v DiscoverAction) MarshalJSON() ([]byte, error) {
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"DiscoverAction\","), b[1:]...), nil
}
