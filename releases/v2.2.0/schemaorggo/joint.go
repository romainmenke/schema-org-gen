...
// Joint see : https://schema.org/Joint
type Joint struct {
	...
	// BiomechnicalClass see : https://schema.org/biomechnicalClass
	// The biomechanical properties of the bone.
	// types : Text
	BiomechnicalClass []string `json:"biomechnicalClass,omitempty"`
	...
	// FunctionalClass see : https://schema.org/functionalClass
	...
	// StructuralClass see : https://schema.org/structuralClass
	// The name given to how bone physically connects to each other.
	// types : Text
	StructuralClass []string `json:"structuralClass,omitempty"`
...
func (v Joint) MarshalJSON() ([]byte, error) {
	type Alias Joint
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"Joint\","), b[1:]...), nil
}
