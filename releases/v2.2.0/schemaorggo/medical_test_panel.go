...
type MedicalTestPanel struct {
	...
	// SubTest see : https://schema.org/subTest
...
func (v MedicalTestPanel) MarshalJSON() ([]byte, error) {
	type Alias MedicalTestPanel
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalTestPanel\","), b[1:]...), nil
}
