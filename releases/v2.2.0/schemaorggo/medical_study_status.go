...
// MedicalStudyStatus see : https://schema.org/MedicalStudyStatus
...
func (v MedicalStudyStatus) MarshalJSON() ([]byte, error) {
	type Alias MedicalStudyStatus
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalStudyStatus\","), b[1:]...), nil
}
