...
type InfectiousDisease struct {
	...
	// InfectiousAgent see : https://schema.org/infectiousAgent
	// The actual infectious agent, such as a specific bacterium.
	// types : Text
	InfectiousAgent []string `json:"infectiousAgent,omitempty"`

	// InfectiousAgentClass see : https://schema.org/infectiousAgentClass
	...
	// TransmissionMethod see : https://schema.org/transmissionMethod
	// How the disease spreads, either as a route or vector, for example &#39;direct contact&#39;, &#39;Aedes aegypti&#39;, etc.
	// types : Text
	TransmissionMethod []string `json:"transmissionMethod,omitempty"`
...
func (v InfectiousDisease) MarshalJSON() ([]byte, error) {
	type Alias InfectiousDisease
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"InfectiousDisease\","), b[1:]...), nil
}
