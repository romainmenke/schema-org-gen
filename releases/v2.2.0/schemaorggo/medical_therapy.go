...
// MedicalTherapy see : https://schema.org/MedicalTherapy
...
func (v MedicalTherapy) MarshalJSON() ([]byte, error) {
	type Alias MedicalTherapy
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalTherapy\","), b[1:]...), nil
}
