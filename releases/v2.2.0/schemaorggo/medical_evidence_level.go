...
// MedicalEvidenceLevel see : https://schema.org/MedicalEvidenceLevel
...
func (v MedicalEvidenceLevel) MarshalJSON() ([]byte, error) {
	type Alias MedicalEvidenceLevel
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalEvidenceLevel\","), b[1:]...), nil
}
