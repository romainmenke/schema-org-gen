...
type AuthorizeAction struct {
	...
	// With properties from AllocateAction see : https://schema.org/AllocateAction
	//
...
func (v AuthorizeAction) MarshalJSON() ([]byte, error) {
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"AuthorizeAction\","), b[1:]...), nil
}
