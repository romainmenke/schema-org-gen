...
// MedicalDevicePurpose see : https://schema.org/MedicalDevicePurpose
...
func (v MedicalDevicePurpose) MarshalJSON() ([]byte, error) {
	type Alias MedicalDevicePurpose
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalDevicePurpose\","), b[1:]...), nil
}
