...
// MedicalAudience see : https://schema.org/MedicalAudience
type MedicalAudience struct {
	...
	// With properties from PeopleAudience see : https://schema.org/PeopleAudience
	//
...
func (v MedicalAudience) MarshalJSON() ([]byte, error) {
	type Alias MedicalAudience
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalAudience\","), b[1:]...), nil
}
