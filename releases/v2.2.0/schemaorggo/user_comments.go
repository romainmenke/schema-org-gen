...
type UserComments struct {
	...
	// CommentText see : https://schema.org/commentText
	// The text of the UserComment.
	// types : Text
	CommentText []string `json:"commentText,omitempty"`

	// CommentTime see : https://schema.org/commentTime
	// The time at which the UserComment was made.
	// types : Date
	CommentTime []Date `json:"commentTime,omitempty"`
	...
	// Discusses see : https://schema.org/discusses
	...
	// ReplyToUrl see : https://schema.org/replyToUrl
	// The URL at which a reply may be posted to the specified UserComment.
	// types : URL
	ReplyToUrl []string `json:"replyToUrl,omitempty"`
...
func (v UserComments) MarshalJSON() ([]byte, error) {
	type Alias UserComments
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"UserComments\","), b[1:]...), nil
}
