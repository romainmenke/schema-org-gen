...
type ImagingTest struct {
	...
	// ImagingTechnique see : https://schema.org/imagingTechnique
...
func (v ImagingTest) MarshalJSON() ([]byte, error) {
	type Alias ImagingTest
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"ImagingTest\","), b[1:]...), nil
}
