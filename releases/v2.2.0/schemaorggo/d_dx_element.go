...
type DDxElement struct {
	...
	// Diagnosis see : https://schema.org/diagnosis
	...
	// DistinguishingSign see : https://schema.org/distinguishingSign
...
func (v DDxElement) MarshalJSON() ([]byte, error) {
	type Alias DDxElement
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"DDxElement\","), b[1:]...), nil
}
