...
// PhysicalActivityCategory see : https://schema.org/PhysicalActivityCategory
...
func (v PhysicalActivityCategory) MarshalJSON() ([]byte, error) {
	type Alias PhysicalActivityCategory
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"PhysicalActivityCategory\","), b[1:]...), nil
}
