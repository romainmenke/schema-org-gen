...
// MedicalRiskScore see : https://schema.org/MedicalRiskScore
type MedicalRiskScore struct {

	// With properties from MedicalRiskEstimator see : https://schema.org/MedicalRiskEstimator
	//
	...
	// Algorithm see : https://schema.org/algorithm
	...
	// EstimatesRiskOf see : https://schema.org/estimatesRiskOf
	...
	// IncludedRiskFactor see : https://schema.org/includedRiskFactor
...
func (v MedicalRiskScore) MarshalJSON() ([]byte, error) {
	type Alias MedicalRiskScore
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalRiskScore\","), b[1:]...), nil
}
