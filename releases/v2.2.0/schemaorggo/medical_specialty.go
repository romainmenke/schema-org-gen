...
type MedicalSpecialty struct {
	...
	// With properties from Specialty see : https://schema.org/Specialty
	//
...
func (v MedicalSpecialty) MarshalJSON() ([]byte, error) {
	type Alias MedicalSpecialty
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalSpecialty\","), b[1:]...), nil
}
