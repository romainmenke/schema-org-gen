...
// MedicalIntangible see : https://schema.org/MedicalIntangible
...
func (v MedicalIntangible) MarshalJSON() ([]byte, error) {
	type Alias MedicalIntangible
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalIntangible\","), b[1:]...), nil
}
