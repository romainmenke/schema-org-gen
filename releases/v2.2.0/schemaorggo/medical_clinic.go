...
// MedicalClinic see : https://schema.org/MedicalClinic
type MedicalClinic struct {
	...
	// AvailableService see : https://schema.org/availableService
	...
	// MedicalSpecialty see : https://schema.org/medicalSpecialty
...
func (v MedicalClinic) MarshalJSON() ([]byte, error) {
	type Alias MedicalClinic
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalClinic\","), b[1:]...), nil
}
