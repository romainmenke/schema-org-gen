...
// MedicalImagingTechnique see : https://schema.org/MedicalImagingTechnique
...
func (v MedicalImagingTechnique) MarshalJSON() ([]byte, error) {
	type Alias MedicalImagingTechnique
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalImagingTechnique\","), b[1:]...), nil
}
