...
type ExercisePlan struct {
	...
	// ActivityDuration see : https://schema.org/activityDuration
	// Length of time to engage in the activity.
	// types : Duration
	ActivityDuration []*Duration `json:"activityDuration,omitempty"`

	// ActivityFrequency see : https://schema.org/activityFrequency
	// How often one should engage in the activity.
	// types : Text
	ActivityFrequency []string `json:"activityFrequency,omitempty"`
	...
	// AdditionalVariable see : https://schema.org/additionalVariable
	// Any additional component of the exercise prescription that may need to be articulated to the patient. This may include the order of exercises, the number of repetitions of movement, quantitative distance, progressions over time, etc.
	// types : Text
	AdditionalVariable []string `json:"additionalVariable,omitempty"`
	...
	// Intensity see : https://schema.org/intensity
	...
	// Repetitions see : https://schema.org/repetitions
	// Number of times one should repeat the activity.
	// types : Number
	Repetitions []float64 `json:"repetitions,omitempty"`

	// RestPeriods see : https://schema.org/restPeriods
	// How often one should break from the activity.
	// types : Text
	RestPeriods []string `json:"restPeriods,omitempty"`
	...
	// Workload see : https://schema.org/workload
	// Quantitative measure of the physiologic output of the exercise; also referred to as energy expenditure.
	// types : Energy
	Workload []*Energy `json:"workload,omitempty"`
}

func (v ExercisePlan) MarshalJSON() ([]byte, error) {
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"ExercisePlan\","), b[1:]...), nil
}
