...
// VeterinaryCare see : https://schema.org/VeterinaryCare
...
func (v VeterinaryCare) MarshalJSON() ([]byte, error) {
	type Alias VeterinaryCare
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"VeterinaryCare\","), b[1:]...), nil
}
