...
// AnatomicalSystem see : https://schema.org/AnatomicalSystem
class AnatomicalSystem implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'AnatomicalSystem';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->comprised_of );
		if ( ! empty( $serialized ) ) {
			$out['comprisedOf'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->related_structure );
		if ( ! empty( $serialized ) ) {
			$out['relatedStructure'] = $serialized;
		}
