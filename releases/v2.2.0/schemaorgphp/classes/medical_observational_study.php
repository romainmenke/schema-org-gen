...
class MedicalObservationalStudy implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'MedicalObservationalStudy';
	 ...
	 *
	 * @var \MedicalObservationalStudyDesign | \MedicalObservationalStudyDesign[]
	 */
	public $study_design;
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->study_design );
		if ( ! empty( $serialized ) ) {
			$out['studyDesign'] = $serialized;
		}
