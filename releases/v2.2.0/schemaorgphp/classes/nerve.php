...
// Nerve see : https://schema.org/Nerve
class Nerve implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'Nerve';
	 ...
	 *
	 * @var \AnatomicalStructure | \AnatomicalStructure[] | \SuperficialAnatomy | \SuperficialAnatomy[]
	 */
	public $sensory_unit;
	 ...
	 *
	 * @var \BrainStructure | \BrainStructure[]
	 */
	public $sourced_from;
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->branch );
		if ( ! empty( $serialized ) ) {
			$out['branch'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->nerve_motor );
		if ( ! empty( $serialized ) ) {
			$out['nerveMotor'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->sensory_unit );
		if ( ! empty( $serialized ) ) {
			$out['sensoryUnit'] = $serialized;
		}

		$serialized = \SchemaOrg\json_serialize( $this->sourced_from );
		if ( ! empty( $serialized ) ) {
			$out['sourcedFrom'] = $serialized;
		}
