...
class LoseAction implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'LoseAction';

	/**
	 * With properties from AchieveAction see : https://schema.org/AchieveAction
	 */
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->winner );
		if ( ! empty( $serialized ) ) {
