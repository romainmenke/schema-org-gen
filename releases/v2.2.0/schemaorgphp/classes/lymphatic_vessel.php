...
class LymphaticVessel implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'LymphaticVessel';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->originates_from );
		if ( ! empty( $serialized ) ) {
			$out['originatesFrom'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->runs_to );
		if ( ! empty( $serialized ) ) {
			$out['runsTo'] = $serialized;
		}
