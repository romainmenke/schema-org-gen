...
// MedicalScholarlyArticle see : https://schema.org/MedicalScholarlyArticle
class MedicalScholarlyArticle implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'MedicalScholarlyArticle';

	/**
	 * With properties from ScholarlyArticle see : https://schema.org/ScholarlyArticle
	 */
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->publication_type );
		if ( ! empty( $serialized ) ) {
			$out['publicationType'] = $serialized;
		}
