...
// AdultEntertainment see : https://schema.org/AdultEntertainment
...
func (v AdultEntertainment) MarshalJSON() ([]byte, error) {
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"AdultEntertainment\","), b[1:]...), nil
}
