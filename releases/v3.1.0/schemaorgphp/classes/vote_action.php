...
class VoteAction implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'VoteAction';

	/**
	 * With properties from ChooseAction see : https://schema.org/ChooseAction
	 */
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->action_option );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->candidate );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->option );
		if ( ! empty( $serialized ) ) {
			$out['option'] = $serialized;
		}
