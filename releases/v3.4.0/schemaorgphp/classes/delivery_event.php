...
class DeliveryEvent implements \JsonSerializable {
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->access_code );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->available_from );
		if ( ! empty( $serialized ) ) {
			$out['availableFrom'] = $serialized;
		}

		$serialized = \SchemaOrg\json_serialize( $this->available_through );
		if ( ! empty( $serialized ) ) {
