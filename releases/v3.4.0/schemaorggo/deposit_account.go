...
type DepositAccount struct {
	...
	// With properties from BankAccount see : https://schema.org/BankAccount
	//

	// With properties from InvestmentOrDeposit see : https://schema.org/InvestmentOrDeposit
	//
...
func (v DepositAccount) MarshalJSON() ([]byte, error) {
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"DepositAccount\","), b[1:]...), nil
}
