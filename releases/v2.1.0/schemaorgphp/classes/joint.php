...
class Joint implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'Joint';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->biomechnical_class );
		if ( ! empty( $serialized ) ) {
			$out['biomechnicalClass'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->functional_class );
		if ( ! empty( $serialized ) ) {
			$out['functionalClass'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->structural_class );
		if ( ! empty( $serialized ) ) {
			$out['structuralClass'] = $serialized;
		}
