...
class MedicalRiskScore implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'MedicalRiskScore';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->algorithm );
		if ( ! empty( $serialized ) ) {
			$out['algorithm'] = $serialized;
		}
