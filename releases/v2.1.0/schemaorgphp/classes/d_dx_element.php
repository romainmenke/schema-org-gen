...
// DDxElement see : https://schema.org/DDxElement
class DDxElement implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'DDxElement';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->diagnosis );
		if ( ! empty( $serialized ) ) {
			$out['diagnosis'] = $serialized;
		}

		$serialized = \SchemaOrg\json_serialize( $this->distinguishing_sign );
		if ( ! empty( $serialized ) ) {
			$out['distinguishingSign'] = $serialized;
		}
