...
func (v DiagnosticProcedure) MarshalJSON() ([]byte, error) {
	type Alias DiagnosticProcedure
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"DiagnosticProcedure\","), b[1:]...), nil
}
