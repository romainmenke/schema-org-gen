...
type MedicalDevice struct {
	...
	// PostOp see : https://schema.org/postOp
	...
	// PreOp see : https://schema.org/preOp
	// A description of the workup, testing, and other preparations required before implanting this device.
	// types : Text
	PreOp []string `json:"preOp,omitempty"`

	// Procedure see : https://schema.org/procedure
...
func (v MedicalDevice) MarshalJSON() ([]byte, error) {
	type Alias MedicalDevice
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalDevice\","), b[1:]...), nil
}
