...
func (v MaximumDoseSchedule) MarshalJSON() ([]byte, error) {
	type Alias MaximumDoseSchedule
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MaximumDoseSchedule\","), b[1:]...), nil
}
