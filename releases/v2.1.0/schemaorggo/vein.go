...
type Vein struct {
	...
	// DrainsTo see : https://schema.org/drainsTo
	...
	// Tributary see : https://schema.org/tributary
...
func (v Vein) MarshalJSON() ([]byte, error) {
	type Alias Vein
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"Vein\","), b[1:]...), nil
}
