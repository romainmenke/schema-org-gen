...
// DrugCostCategory see : https://schema.org/DrugCostCategory
...
func (v DrugCostCategory) MarshalJSON() ([]byte, error) {
	type Alias DrugCostCategory
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"DrugCostCategory\","), b[1:]...), nil
}
