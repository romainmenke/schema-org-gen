...
type MedicalSign struct {
	...
	// IdentifyingExam see : https://schema.org/identifyingExam
	// A physical examination that can identify this sign.
	// types : PhysicalExam
	IdentifyingExam []*PhysicalExam `json:"identifyingExam,omitempty"`

	// IdentifyingTest see : https://schema.org/identifyingTest
...
func (v MedicalSign) MarshalJSON() ([]byte, error) {
	type Alias MedicalSign
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalSign\","), b[1:]...), nil
}
