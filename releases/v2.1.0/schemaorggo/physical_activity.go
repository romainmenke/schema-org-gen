...
// PhysicalActivity see : https://schema.org/PhysicalActivity
...
func (v PhysicalActivity) MarshalJSON() ([]byte, error) {
	type Alias PhysicalActivity
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"PhysicalActivity\","), b[1:]...), nil
}
