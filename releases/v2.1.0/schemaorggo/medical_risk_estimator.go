...
func (v MedicalRiskEstimator) MarshalJSON() ([]byte, error) {
	type Alias MedicalRiskEstimator
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalRiskEstimator\","), b[1:]...), nil
}
