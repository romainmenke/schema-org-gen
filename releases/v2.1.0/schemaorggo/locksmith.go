...
// Locksmith see : https://schema.org/Locksmith
...
func (v Locksmith) MarshalJSON() ([]byte, error) {
	type Alias Locksmith
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"Locksmith\","), b[1:]...), nil
}
