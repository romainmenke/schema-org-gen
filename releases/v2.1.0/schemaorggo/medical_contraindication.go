...
// MedicalContraindication see : https://schema.org/MedicalContraindication
...
func (v MedicalContraindication) MarshalJSON() ([]byte, error) {
	type Alias MedicalContraindication
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalContraindication\","), b[1:]...), nil
}
