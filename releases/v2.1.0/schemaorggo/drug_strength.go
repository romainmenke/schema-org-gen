...
// DrugStrength see : https://schema.org/DrugStrength
type DrugStrength struct {
	...
	// AvailableIn see : https://schema.org/availableIn
	...
	// StrengthUnit see : https://schema.org/strengthUnit
	// The units of an active ingredient&#39;s strength, e.g. mg.
	// types : Text
	StrengthUnit []string `json:"strengthUnit,omitempty"`

	// StrengthValue see : https://schema.org/strengthValue
	// The value of an active ingredient&#39;s strength, e.g. 325.
	// types : Number
	StrengthValue []float64 `json:"strengthValue,omitempty"`
...
func (v DrugStrength) MarshalJSON() ([]byte, error) {
	type Alias DrugStrength
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"DrugStrength\","), b[1:]...), nil
}
