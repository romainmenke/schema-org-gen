...
// MedicalWebPage see : https://schema.org/MedicalWebPage
type MedicalWebPage struct {
	...
	// Aspect see : https://schema.org/aspect
...
func (v MedicalWebPage) MarshalJSON() ([]byte, error) {
	type Alias MedicalWebPage
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalWebPage\","), b[1:]...), nil
}
