...
// RoofingContractor see : https://schema.org/RoofingContractor
...
func (v RoofingContractor) MarshalJSON() ([]byte, error) {
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"RoofingContractor\","), b[1:]...), nil
}
