...
// GeneralContractor see : https://schema.org/GeneralContractor
type GeneralContractor struct {
	...
	// With properties from ProfessionalService see : https://schema.org/ProfessionalService
	//
...
func (v GeneralContractor) MarshalJSON() ([]byte, error) {
	type Alias GeneralContractor
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"GeneralContractor\","), b[1:]...), nil
}
