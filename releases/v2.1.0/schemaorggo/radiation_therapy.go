...
// RadiationTherapy see : https://schema.org/RadiationTherapy
...
func (v RadiationTherapy) MarshalJSON() ([]byte, error) {
	type Alias RadiationTherapy
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"RadiationTherapy\","), b[1:]...), nil
}
