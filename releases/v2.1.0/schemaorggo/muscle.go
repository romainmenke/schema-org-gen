...
type Muscle struct {
	...
	// Antagonist see : https://schema.org/antagonist
	...
	// BloodSupply see : https://schema.org/bloodSupply
	...
	// Insertion see : https://schema.org/insertion
	...
	// MuscleAction see : https://schema.org/muscleAction
	// The movement the muscle generates.
	// types : Text
	MuscleAction []string `json:"muscleAction,omitempty"`
	...
	// Origin see : https://schema.org/origin
...
func (v Muscle) MarshalJSON() ([]byte, error) {
	type Alias Muscle
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"Muscle\","), b[1:]...), nil
}
