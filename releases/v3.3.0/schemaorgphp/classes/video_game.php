...
class VideoGame implements \JsonSerializable {
	...
	/**
	 * With properties from Game see : https://schema.org/Game
	 */
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->game_server );
		if ( ! empty( $serialized ) ) {
			$out['gameServer'] = $serialized;
		}
		
		$serialized = \SchemaOrg\json_serialize( $this->game_tip );
		if ( ! empty( $serialized ) ) {
