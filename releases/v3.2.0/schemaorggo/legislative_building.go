...
// LegislativeBuilding see : https://schema.org/LegislativeBuilding
...
func (v LegislativeBuilding) MarshalJSON() ([]byte, error) {
	type Alias LegislativeBuilding
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"LegislativeBuilding\","), b[1:]...), nil
}
