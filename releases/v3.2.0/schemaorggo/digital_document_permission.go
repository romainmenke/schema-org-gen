...
type DigitalDocumentPermission struct {
	...
	// types : Person Organization Audience ContactPoint
...
func (v DigitalDocumentPermission) MarshalJSON() ([]byte, error) {
	type Alias DigitalDocumentPermission
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"DigitalDocumentPermission\","), b[1:]...), nil
}
