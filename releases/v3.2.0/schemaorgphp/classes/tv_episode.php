...
class TVEpisode implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'TVEpisode';

	/**
	 * With properties from Episode see : https://schema.org/Episode
	 */
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->episode_number );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->part_of_season );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->subtitle_language );
		if ( ! empty( $serialized ) ) {
