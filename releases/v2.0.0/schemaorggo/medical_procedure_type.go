...
// MedicalProcedureType see : https://schema.org/MedicalProcedureType
...
func (v MedicalProcedureType) MarshalJSON() ([]byte, error) {
	type Alias MedicalProcedureType
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalProcedureType\","), b[1:]...), nil
}
