...
func (v PalliativeProcedure) MarshalJSON() ([]byte, error) {
	type Alias PalliativeProcedure
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"PalliativeProcedure\","), b[1:]...), nil
}
