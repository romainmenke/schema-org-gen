...
// MedicalEnumeration see : https://schema.org/MedicalEnumeration
...
func (v MedicalEnumeration) MarshalJSON() ([]byte, error) {
	type Alias MedicalEnumeration
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalEnumeration\","), b[1:]...), nil
}
