...
// PhysicalTherapy see : https://schema.org/PhysicalTherapy
...
func (v PhysicalTherapy) MarshalJSON() ([]byte, error) {
	type Alias PhysicalTherapy
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"PhysicalTherapy\","), b[1:]...), nil
}
