...
// MedicalIndication see : https://schema.org/MedicalIndication
...
func (v MedicalIndication) MarshalJSON() ([]byte, error) {
	type Alias MedicalIndication
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalIndication\","), b[1:]...), nil
}
