...
// MedicalRiskFactor see : https://schema.org/MedicalRiskFactor
type MedicalRiskFactor struct {
	...
	// IncreasesRiskOf see : https://schema.org/increasesRiskOf
...
func (v MedicalRiskFactor) MarshalJSON() ([]byte, error) {
	type Alias MedicalRiskFactor
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalRiskFactor\","), b[1:]...), nil
}
