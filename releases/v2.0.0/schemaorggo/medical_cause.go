...
// MedicalCause see : https://schema.org/MedicalCause
type MedicalCause struct {
	...
	// CauseOf see : https://schema.org/causeOf
...
func (v MedicalCause) MarshalJSON() ([]byte, error) {
	type Alias MedicalCause
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalCause\","), b[1:]...), nil
}
