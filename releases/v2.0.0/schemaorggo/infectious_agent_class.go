...
func (v InfectiousAgentClass) MarshalJSON() ([]byte, error) {
	type Alias InfectiousAgentClass
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"InfectiousAgentClass\","), b[1:]...), nil
}
