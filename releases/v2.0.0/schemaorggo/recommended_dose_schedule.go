...
// RecommendedDoseSchedule see : https://schema.org/RecommendedDoseSchedule
...
func (v RecommendedDoseSchedule) MarshalJSON() ([]byte, error) {
	type Alias RecommendedDoseSchedule
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"RecommendedDoseSchedule\","), b[1:]...), nil
}
