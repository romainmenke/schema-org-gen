...
// PsychologicalTreatment see : https://schema.org/PsychologicalTreatment
...
func (v PsychologicalTreatment) MarshalJSON() ([]byte, error) {
	type Alias PsychologicalTreatment
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"PsychologicalTreatment\","), b[1:]...), nil
}
