...
// MedicalTrialDesign see : https://schema.org/MedicalTrialDesign
...
func (v MedicalTrialDesign) MarshalJSON() ([]byte, error) {
	type Alias MedicalTrialDesign
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalTrialDesign\","), b[1:]...), nil
}
