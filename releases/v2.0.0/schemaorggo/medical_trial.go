...
type MedicalTrial struct {
	...
	// Phase see : https://schema.org/phase
	...
	// TrialDesign see : https://schema.org/trialDesign
...
func (v MedicalTrial) MarshalJSON() ([]byte, error) {
	type Alias MedicalTrial
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalTrial\","), b[1:]...), nil
}
