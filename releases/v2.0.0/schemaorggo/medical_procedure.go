...
// MedicalProcedure see : https://schema.org/MedicalProcedure
...
func (v MedicalProcedure) MarshalJSON() ([]byte, error) {
	type Alias MedicalProcedure
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalProcedure\","), b[1:]...), nil
}
