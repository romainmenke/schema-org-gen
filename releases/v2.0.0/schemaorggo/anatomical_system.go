...
type AnatomicalSystem struct {
	...
	// ComprisedOf see : https://schema.org/comprisedOf
	...
	// RelatedStructure see : https://schema.org/relatedStructure
...
func (v AnatomicalSystem) MarshalJSON() ([]byte, error) {
	type Alias AnatomicalSystem
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"AnatomicalSystem\","), b[1:]...), nil
}
