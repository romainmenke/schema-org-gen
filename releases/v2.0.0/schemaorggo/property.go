...
type Property struct {
	...
	// DomainIncludes see : https://schema.org/domainIncludes
	...
	// InverseOf see : https://schema.org/inverseOf
	...
	// RangeIncludes see : https://schema.org/rangeIncludes
...
func (v Property) MarshalJSON() ([]byte, error) {
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"Property\","), b[1:]...), nil
}
