...
type Nerve struct {
	...
	// Branch see : https://schema.org/branch
	...
	// NerveMotor see : https://schema.org/nerveMotor
...
func (v Nerve) MarshalJSON() ([]byte, error) {
	type Alias Nerve
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"Nerve\","), b[1:]...), nil
}
