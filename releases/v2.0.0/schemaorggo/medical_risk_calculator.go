...
// MedicalRiskCalculator see : https://schema.org/MedicalRiskCalculator
...
func (v MedicalRiskCalculator) MarshalJSON() ([]byte, error) {
	type Alias MedicalRiskCalculator
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalRiskCalculator\","), b[1:]...), nil
}
