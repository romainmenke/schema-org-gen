...
// TreatmentIndication see : https://schema.org/TreatmentIndication
...
func (v TreatmentIndication) MarshalJSON() ([]byte, error) {
	type Alias TreatmentIndication
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"TreatmentIndication\","), b[1:]...), nil
}
