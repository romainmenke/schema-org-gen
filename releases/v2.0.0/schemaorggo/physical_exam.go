...
// PhysicalExam see : https://schema.org/PhysicalExam
...
func (v PhysicalExam) MarshalJSON() ([]byte, error) {
	type Alias PhysicalExam
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"PhysicalExam\","), b[1:]...), nil
}
