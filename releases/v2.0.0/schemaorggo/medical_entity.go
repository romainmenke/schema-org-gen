...
// MedicalEntity see : https://schema.org/MedicalEntity
...
func (v MedicalEntity) MarshalJSON() ([]byte, error) {
	type Alias MedicalEntity
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalEntity\","), b[1:]...), nil
}
