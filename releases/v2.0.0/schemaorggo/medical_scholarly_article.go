...
type MedicalScholarlyArticle struct {
	...
	// PublicationType see : https://schema.org/publicationType
...
func (v MedicalScholarlyArticle) MarshalJSON() ([]byte, error) {
	type Alias MedicalScholarlyArticle
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalScholarlyArticle\","), b[1:]...), nil
}
