...
// LymphaticVessel see : https://schema.org/LymphaticVessel
type LymphaticVessel struct {
	...
	// OriginatesFrom see : https://schema.org/originatesFrom
	...
	// RegionDrained see : https://schema.org/regionDrained
	...
	// RunsTo see : https://schema.org/runsTo
...
func (v LymphaticVessel) MarshalJSON() ([]byte, error) {
	type Alias LymphaticVessel
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"LymphaticVessel\","), b[1:]...), nil
}
