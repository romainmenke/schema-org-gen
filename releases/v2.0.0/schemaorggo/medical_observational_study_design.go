...
// MedicalObservationalStudyDesign see : https://schema.org/MedicalObservationalStudyDesign
...
func (v MedicalObservationalStudyDesign) MarshalJSON() ([]byte, error) {
	type Alias MedicalObservationalStudyDesign
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalObservationalStudyDesign\","), b[1:]...), nil
}
