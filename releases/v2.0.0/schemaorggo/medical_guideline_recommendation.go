...
// MedicalGuidelineRecommendation see : https://schema.org/MedicalGuidelineRecommendation
type MedicalGuidelineRecommendation struct {

	// With properties from MedicalGuideline see : https://schema.org/MedicalGuideline
	//
	...
	// GuidelineDate see : https://schema.org/guidelineDate
	// Date on which this guideline&#39;s recommendation was made.
	// types : Date
	GuidelineDate []Date `json:"guidelineDate,omitempty"`

	// GuidelineSubject see : https://schema.org/guidelineSubject
	...
	// RecommendationStrength see : https://schema.org/recommendationStrength
...
func (v MedicalGuidelineRecommendation) MarshalJSON() ([]byte, error) {
	type Alias MedicalGuidelineRecommendation
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalGuidelineRecommendation\","), b[1:]...), nil
}
