...
type SoftwareSourceCode struct {
	...
	// types : Language
	ProgrammingLanguage []*Language `json:"programmingLanguage,omitempty"`
	...
	// Runtime see : https://schema.org/runtime
	...
	// SampleType see : https://schema.org/sampleType
	// Full (compile ready) solution, code snippet, inline code, scripts, template.
	// types : Text
...
func (v SoftwareSourceCode) MarshalJSON() ([]byte, error) {
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"SoftwareSourceCode\","), b[1:]...), nil
}
