...
// BrainStructure see : https://schema.org/BrainStructure
...
func (v BrainStructure) MarshalJSON() ([]byte, error) {
	type Alias BrainStructure
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"BrainStructure\","), b[1:]...), nil
}
