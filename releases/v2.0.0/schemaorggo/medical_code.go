...
// MedicalCode see : https://schema.org/MedicalCode
type MedicalCode struct {
	...
	// CodeValue see : https://schema.org/codeValue
	// The actual code.
	// types : Text
	CodeValue []string `json:"codeValue,omitempty"`

	// CodingSystem see : https://schema.org/codingSystem
	// The coding system, e.g. &#39;ICD-10&#39;.
	// types : Text
	CodingSystem []string `json:"codingSystem,omitempty"`
...
func (v MedicalCode) MarshalJSON() ([]byte, error) {
	type Alias MedicalCode
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalCode\","), b[1:]...), nil
}
