...
// PreventionIndication see : https://schema.org/PreventionIndication
type PreventionIndication struct {

	// With properties from MedicalIndication see : https://schema.org/MedicalIndication
	//
...
func (v PreventionIndication) MarshalJSON() ([]byte, error) {
	type Alias PreventionIndication
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"PreventionIndication\","), b[1:]...), nil
}
