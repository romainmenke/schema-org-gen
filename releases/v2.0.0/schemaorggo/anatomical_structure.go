...
// AnatomicalStructure see : https://schema.org/AnatomicalStructure
...
func (v AnatomicalStructure) MarshalJSON() ([]byte, error) {
	type Alias AnatomicalStructure
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"AnatomicalStructure\","), b[1:]...), nil
}
