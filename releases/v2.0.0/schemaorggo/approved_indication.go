...
// ApprovedIndication see : https://schema.org/ApprovedIndication
...
func (v ApprovedIndication) MarshalJSON() ([]byte, error) {
	type Alias ApprovedIndication
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"ApprovedIndication\","), b[1:]...), nil
}
