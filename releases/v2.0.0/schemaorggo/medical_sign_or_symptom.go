...
// MedicalSignOrSymptom see : https://schema.org/MedicalSignOrSymptom
...
func (v MedicalSignOrSymptom) MarshalJSON() ([]byte, error) {
	type Alias MedicalSignOrSymptom
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalSignOrSymptom\","), b[1:]...), nil
}
