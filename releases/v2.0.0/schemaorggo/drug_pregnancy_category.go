...
// DrugPregnancyCategory see : https://schema.org/DrugPregnancyCategory
...
func (v DrugPregnancyCategory) MarshalJSON() ([]byte, error) {
	type Alias DrugPregnancyCategory
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"DrugPregnancyCategory\","), b[1:]...), nil
}
