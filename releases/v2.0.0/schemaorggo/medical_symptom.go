...
// MedicalSymptom see : https://schema.org/MedicalSymptom
...
func (v MedicalSymptom) MarshalJSON() ([]byte, error) {
	type Alias MedicalSymptom
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalSymptom\","), b[1:]...), nil
}
