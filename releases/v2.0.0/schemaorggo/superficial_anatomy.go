...
type SuperficialAnatomy struct {
	...
	// RelatedAnatomy see : https://schema.org/relatedAnatomy
	...
	// Significance see : https://schema.org/significance
...
func (v SuperficialAnatomy) MarshalJSON() ([]byte, error) {
	type Alias SuperficialAnatomy
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"SuperficialAnatomy\","), b[1:]...), nil
}
