...
// DiagnosticLab see : https://schema.org/DiagnosticLab
type DiagnosticLab struct {
	...
	// AvailableTest see : https://schema.org/availableTest
...
func (v DiagnosticLab) MarshalJSON() ([]byte, error) {
	type Alias DiagnosticLab
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"DiagnosticLab\","), b[1:]...), nil
}
