...
// MedicalGuidelineContraindication see : https://schema.org/MedicalGuidelineContraindication
...
func (v MedicalGuidelineContraindication) MarshalJSON() ([]byte, error) {
	type Alias MedicalGuidelineContraindication
	...
	return append([]byte("{\"@context\":\"http://schema.org\",\"@type\":\"MedicalGuidelineContraindication\","), b[1:]...), nil
}
