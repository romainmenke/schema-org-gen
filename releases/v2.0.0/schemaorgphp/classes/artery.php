...
class Artery implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'Artery';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->arterial_branch );
		if ( ! empty( $serialized ) ) {
			$out['arterialBranch'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->source );
		if ( ! empty( $serialized ) ) {
			$out['source'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->supply_to );
		if ( ! empty( $serialized ) ) {
			$out['supplyTo'] = $serialized;
		}
