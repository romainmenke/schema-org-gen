...
class Diet implements \JsonSerializable {
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->diet_features );
		if ( ! empty( $serialized ) ) {
			$out['dietFeatures'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->endorsers );
		if ( ! empty( $serialized ) ) {
			$out['endorsers'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->expert_considerations );
		if ( ! empty( $serialized ) ) {
			$out['expertConsiderations'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->overview );
		if ( ! empty( $serialized ) ) {
			$out['overview'] = $serialized;
		}

		$serialized = \SchemaOrg\json_serialize( $this->physiological_benefits );
		if ( ! empty( $serialized ) ) {
			$out['physiologicalBenefits'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->proprietary_name );
		if ( ! empty( $serialized ) ) {
			$out['proprietaryName'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->risks );
		if ( ! empty( $serialized ) ) {
			$out['risks'] = $serialized;
		}
