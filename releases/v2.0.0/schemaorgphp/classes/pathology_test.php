...
class PathologyTest implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'PathologyTest';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->tissue_sample );
		if ( ! empty( $serialized ) ) {
			$out['tissueSample'] = $serialized;
		}
