...
// MedicalSign see : https://schema.org/MedicalSign
class MedicalSign implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'MedicalSign';

	/**
	 * With properties from MedicalSignOrSymptom see : https://schema.org/MedicalSignOrSymptom
	 */
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->identifying_exam );
		if ( ! empty( $serialized ) ) {
			$out['identifyingExam'] = $serialized;
		}

		$serialized = \SchemaOrg\json_serialize( $this->identifying_test );
		if ( ! empty( $serialized ) ) {
			$out['identifyingTest'] = $serialized;
		}
