...
// InfectiousDisease see : https://schema.org/InfectiousDisease
class InfectiousDisease implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'InfectiousDisease';

	/**
	 * With properties from MedicalCondition see : https://schema.org/MedicalCondition
	 */
	 ...
	 * @var string | string[]
	 */
	public $infectious_agent;

	/**
	 * The class of infectious agent (bacteria, prion, etc.) that causes the disease.
	 * see : https://schema.org/infectiousAgentClass
	 *
	 * @var \InfectiousAgentClass | \InfectiousAgentClass[]
	 */
	public $infectious_agent_class;
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->infectious_agent );
		if ( ! empty( $serialized ) ) {
			$out['infectiousAgent'] = $serialized;
		}

		$serialized = \SchemaOrg\json_serialize( $this->infectious_agent_class );
		if ( ! empty( $serialized ) ) {
			$out['infectiousAgentClass'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->transmission_method );
		if ( ! empty( $serialized ) ) {
			$out['transmissionMethod'] = $serialized;
		}
