...
class DrugStrength implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'DrugStrength';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->available_in );
		if ( ! empty( $serialized ) ) {
			$out['availableIn'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->strength_unit );
		if ( ! empty( $serialized ) ) {
			$out['strengthUnit'] = $serialized;
		}

		$serialized = \SchemaOrg\json_serialize( $this->strength_value );
		if ( ! empty( $serialized ) ) {
			$out['strengthValue'] = $serialized;
		}
