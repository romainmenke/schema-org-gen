...
class ScheduleAction implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'ScheduleAction';

	/**
	 * With properties from PlanAction see : https://schema.org/PlanAction
	 */
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->scheduled_time );
		if ( ! empty( $serialized ) ) {
