...
class WarrantyPromise implements \JsonSerializable {
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->duration_of_warranty );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->warranty_scope );
		if ( ! empty( $serialized ) ) {
