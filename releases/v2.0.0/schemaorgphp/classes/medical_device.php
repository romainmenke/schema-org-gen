...
// MedicalDevice see : https://schema.org/MedicalDevice
class MedicalDevice implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'MedicalDevice';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->post_op );
		if ( ! empty( $serialized ) ) {
			$out['postOp'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->pre_op );
		if ( ! empty( $serialized ) ) {
			$out['preOp'] = $serialized;
		}

		$serialized = \SchemaOrg\json_serialize( $this->procedure );
		if ( ! empty( $serialized ) ) {
			$out['procedure'] = $serialized;
		}

		$serialized = \SchemaOrg\json_serialize( $this->purpose );
		if ( ! empty( $serialized ) ) {
