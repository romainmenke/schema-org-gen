...
// MedicalTestPanel see : https://schema.org/MedicalTestPanel
class MedicalTestPanel implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'MedicalTestPanel';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->sub_test );
		if ( ! empty( $serialized ) ) {
			$out['subTest'] = $serialized;
		}
