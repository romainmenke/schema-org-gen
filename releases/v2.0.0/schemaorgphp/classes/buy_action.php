...
class BuyAction implements \JsonSerializable {
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->vendor );
		if ( ! empty( $serialized ) ) {
			$out['vendor'] = $serialized;
		}

		$serialized = \SchemaOrg\json_serialize( $this->warranty_promise );
		if ( ! empty( $serialized ) ) {
			$out['warrantyPromise'] = $serialized;
		}
