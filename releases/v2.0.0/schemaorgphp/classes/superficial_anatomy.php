...
// SuperficialAnatomy see : https://schema.org/SuperficialAnatomy
class SuperficialAnatomy implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'SuperficialAnatomy';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->related_anatomy );
		if ( ! empty( $serialized ) ) {
			$out['relatedAnatomy'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->significance );
		if ( ! empty( $serialized ) ) {
			$out['significance'] = $serialized;
		}
