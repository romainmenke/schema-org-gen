...
class MedicalCode implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'MedicalCode';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->code_value );
		if ( ! empty( $serialized ) ) {
			$out['codeValue'] = $serialized;
		}

		$serialized = \SchemaOrg\json_serialize( $this->coding_system );
		if ( ! empty( $serialized ) ) {
			$out['codingSystem'] = $serialized;
		}
