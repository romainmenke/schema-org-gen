...
class CookAction implements \JsonSerializable {
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->food_establishment );
		if ( ! empty( $serialized ) ) {
			$out['foodEstablishment'] = $serialized;
		}

		$serialized = \SchemaOrg\json_serialize( $this->food_event );
		if ( ! empty( $serialized ) ) {
		...
		$serialized = \SchemaOrg\json_serialize( $this->recipe );
		if ( ! empty( $serialized ) ) {
