...
class DiagnosticLab implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'DiagnosticLab';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->available_test );
		if ( ! empty( $serialized ) ) {
			$out['availableTest'] = $serialized;
		}
