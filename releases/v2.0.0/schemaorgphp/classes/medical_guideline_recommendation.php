...
class MedicalGuidelineRecommendation implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'MedicalGuidelineRecommendation';
	 ...
	 * @var string | string[]
	 */
	public $recommendation_strength;
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->recommendation_strength );
		if ( ! empty( $serialized ) ) {
			$out['recommendationStrength'] = $serialized;
		}
