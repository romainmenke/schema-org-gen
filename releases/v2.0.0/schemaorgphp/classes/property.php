...
class Property implements \JsonSerializable {
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->domain_includes );
		if ( ! empty( $serialized ) ) {
			$out['domainIncludes'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->inverse_of );
		if ( ! empty( $serialized ) ) {
			$out['inverseOf'] = $serialized;
		}
		...
		$serialized = \SchemaOrg\json_serialize( $this->range_includes );
		if ( ! empty( $serialized ) ) {
			$out['rangeIncludes'] = $serialized;
		}
