...
class MedicalRiskFactor implements \JsonSerializable {

	public static $context = 'http://schema.org';
	public static $type    = 'MedicalRiskFactor';
	...
	public function jsonSerialize() {
		...
		$serialized = \SchemaOrg\json_serialize( $this->increases_risk_of );
		if ( ! empty( $serialized ) ) {
			$out['increasesRiskOf'] = $serialized;
		}
