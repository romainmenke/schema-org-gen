...
InformAction// AdditionalNumberOfGuests see : /additionalNumberOfGuests
// If responding yes, the number of guests who will attend in addition to the invitee.
AdditionalNumberOfGuests string `json:"additionalNumberOfGuests"`
...
RsvpResponse string `json:"rsvpResponse"`
