...
Rating// ItemReviewed see : /itemReviewed
...
AggregateRating interface{} `json:"aggregateRating"` // types : Brand CreativeWork Event Offer Organization Place Product Service
