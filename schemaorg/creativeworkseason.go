...
PartOfSeries string `json:"partOfSeries"`
...
ContainsSeason interface{} `json:"containsSeason"` // types : RadioSeries TVSeries VideoGameSeries

// PartOfSeason see : /partOfSeason
// The season to which this episode belongs. 
PartOfSeason interface{} `json:"partOfSeason"` // types : Clip Episode
