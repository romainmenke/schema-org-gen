...
MediaObject// Caption see : /caption
...
AssociatedArticle string `json:"associatedArticle"`
...
// Logo see : /logo
// An associated logo. 
Logo interface{} `json:"logo"` // types : Brand Organization Place Product Service

// Photo see : /photo
// A photograph of this place.  Supersedes photos (see: https://schema.org/photos).
Photo string `json:"photo"`

// PrimaryImageOfPage see : /primaryImageOfPage
...
// Thumbnail see : /thumbnail
// Thumbnail image for an image or video. 
Thumbnail interface{} `json:"thumbnail"` // types : ImageObject VideoObject
