...
// AcceptedPaymentMethod see : /acceptedPaymentMethod
// The payment method(s) accepted by seller for this offer. 
AcceptedPaymentMethod interface{} `json:"acceptedPaymentMethod"` // types : Demand Offer

// AppliesToPaymentMethod see : /appliesToPaymentMethod
// The payment method(s) to which the payment charge specification applies. 
AppliesToPaymentMethod string `json:"appliesToPaymentMethod"`

// PaymentMethod see : /paymentMethod
// The name of the credit card or other method of payment for the order. 
PaymentMethod interface{} `json:"paymentMethod"` // types : Invoice Order
