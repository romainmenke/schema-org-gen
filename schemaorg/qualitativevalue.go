...
Enumeration// AdditionalProperty see : /additionalProperty
...
FuelType interface{} `json:"fuelType"` // types : EngineSpecification Vehicle
...
LodgingUnitType string `json:"lodgingUnitType"`
...
PassengerPriorityStatus string `json:"passengerPriorityStatus"`
