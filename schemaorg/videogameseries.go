...
NumberOfEpisodes string `json:"numberOfEpisodes"`
...
NumberOfSeasons string `json:"numberOfSeasons"`
...
// PublisherImprint see : /publisherImprint
...
// TranslationOfWork see : /translationOfWork
// The work that this work has been translated from. e.g. 物种起源 is a translationOf “On the Origin of Species” Inverse property: workTranslation (see: https://schema.org/workTranslation).
...
// WorkTranslation see : /workTranslation
// A work that is a translation of the content of this work. e.g. 西遊記 has an English workTranslation “Journey to the West”,a German workTranslation “Monkeys Pilgerfahrt” and a Vietnamese  translation Tây du ký bình khảo. Inverse property: translationOfWork (see: https://schema.org/translationOfWork).
