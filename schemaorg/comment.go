...
CreativeWork// DownvoteCount see : /downvoteCount
// The number of downvotes this question, answer or comment has received from the community.
DownvoteCount string `json:"downvoteCount"`
...
// Comment see : /comment
// Comments, typically from users. 
Comment interface{} `json:"comment"` // types : CreativeWork RsvpAction

// ResultComment see : /resultComment
// A sub property of result. The Comment created or sent as a result of this action. 
ResultComment interface{} `json:"resultComment"` // types : CommentAction ReplyAction
