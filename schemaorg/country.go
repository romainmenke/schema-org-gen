...
AdministrativeArea// AdditionalProperty see : /additionalProperty
...
AddressCountry interface{} `json:"addressCountry"` // types : GeoCoordinates GeoShape PostalAddress

// CountryOfOrigin see : /countryOfOrigin
// The country of the principal offices of the production company or individual responsible for the movie or program. 
CountryOfOrigin interface{} `json:"countryOfOrigin"` // types : Movie TVEpisode TVSeason TVSeries
