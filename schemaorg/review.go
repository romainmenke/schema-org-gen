...
CreativeWork// ItemReviewed see : /itemReviewed
...
ResultReview string `json:"resultReview"`

// Review see : /review
// A review of the item.  Supersedes reviews (see: https://schema.org/reviews).
Review interface{} `json:"review"` // types : Brand CreativeWork Event Offer Organization Place Product Service
