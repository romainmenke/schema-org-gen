...
Enumeration// SupersededBy see : http://meta.schema.org/supersededBy
...
// AppliesToDeliveryMethod see : /appliesToDeliveryMethod
// The delivery method(s) to which the delivery charge or payment charge specification applies. 
AppliesToDeliveryMethod interface{} `json:"appliesToDeliveryMethod"` // types : DeliveryChargeSpecification PaymentChargeSpecification

// AvailableDeliveryMethod see : /availableDeliveryMethod
// The delivery method(s) available for this offer. 
AvailableDeliveryMethod interface{} `json:"availableDeliveryMethod"` // types : Demand Offer

// DeliveryMethod see : /deliveryMethod
// A sub property of instrument. The method of delivery. 
DeliveryMethod interface{} `json:"deliveryMethod"` // types : OrderAction ReceiveAction SendAction TrackAction

// HasDeliveryMethod see : /hasDeliveryMethod
// Method used for delivery or shipping. 
HasDeliveryMethod interface{} `json:"hasDeliveryMethod"` // types : DeliveryEvent ParcelDelivery
