...
PeopleAudience// ChildMaxAge see : /childMaxAge
// Maximal age of the child.
ChildMaxAge string `json:"childMaxAge"`

// ChildMinAge see : /childMinAge
// Minimal age of the child.
ChildMinAge string `json:"childMinAge"`
...
RequiredMaxAge string `json:"requiredMaxAge"`

// RequiredMinAge see : /requiredMinAge
// Audiences defined by a person's minimum age.
RequiredMinAge string `json:"requiredMinAge"`
...
SuggestedMaxAge string `json:"suggestedMaxAge"`

// SuggestedMinAge see : /suggestedMinAge
// Minimal age recommended for viewing content.
SuggestedMinAge string `json:"suggestedMinAge"`
