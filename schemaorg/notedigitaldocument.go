...
DigitalDocument// HasDigitalDocumentPermission see : /hasDigitalDocumentPermission
// A permission related to the access to this document (e.g. permission to read or write an electronic document). For a public document, specify a grantee with an Audience with audienceType equal to "public".
HasDigitalDocumentPermission string `json:"hasDigitalDocumentPermission"`
...
// ContentReferenceTime see : /contentReferenceTime
...
// PublisherImprint see : http://bib.pending.1.schemaorgae.appspot.com/publisherImprint
...
// TranslationOfWork see : http://bib.pending.1.schemaorgae.appspot.com/translationOfWork
// The work that this work has been translated from. e.g. 物种起源 is a translationOf “On the Origin of Species” Inverse property: workTranslation (see: https://schema.orghttp://bib.pending.1.schemaorgae.appspot.com/workTranslation).
...
// WorkTranslation see : http://bib.pending.1.schemaorgae.appspot.com/workTranslation
// A work that is a translation of the content of this work. e.g. 西遊記 has an English workTranslation “Journey to the West”,a German workTranslation “Monkeys Pilgerfahrt” and a Vietnamese  translation Tây du ký bình khảo. Inverse property: translationOfWork (see: https://schema.orghttp://bib.pending.1.schemaorgae.appspot.com/translationOfWork).
