...
BroadcastOfEvent string `json:"broadcastOfEvent"`

// Event see : /event
// Upcoming or past event associated with this place, organization, or action.  Supersedes events (see: https://schema.org/events).
Event interface{} `json:"event"` // types : InformAction InviteAction JoinAction LeaveAction Organization Place PlayAction

// FirstPerformance see : /firstPerformance
// The date and place the work was first performed. 
FirstPerformance string `json:"firstPerformance"`
