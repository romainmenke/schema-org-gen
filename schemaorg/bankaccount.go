...
FinancialProduct// AccountMinimumInflow see : http://pending.schema.org/accountMinimumInflow
// A minimum amount that has to be paid in every month.
AccountMinimumInflow string `json:"accountMinimumInflow"`
...
AccountOverdraftLimit string `json:"accountOverdraftLimit"`
