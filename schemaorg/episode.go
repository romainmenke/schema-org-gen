...
PartOfSeason string `json:"partOfSeason"`
...
Episode interface{} `json:"episode"` // types : CreativeWorkSeason RadioSeries TVSeries VideoGameSeries

// PartOfEpisode see : /partOfEpisode
// The episode to which this clip belongs. 
PartOfEpisode string `json:"partOfEpisode"`
