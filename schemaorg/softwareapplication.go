...
CreativeWork// ApplicationCategory see : /applicationCategory
...
ActionApplication string `json:"actionApplication"`

// InteractionService see : /interactionService
// The WebSite or SoftwareApplication where the interactions took place. 
InteractionService string `json:"interactionService"`
