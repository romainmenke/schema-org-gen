...
// GracePeriod see : https://schema.orghttp://pending.schema.org/gracePeriod
// The period of time after any due date that the borrower has to fulfil its obligations before a default (failure to pay) is deemed to have occurred.
GracePeriod *Duration `json:"gracePeriod"`

// LoanRepaymentForm see : https://schema.orghttp://pending.schema.org/loanRepaymentForm
...
// LoanType see : https://schema.orghttp://pending.schema.org/loanType
// The type of a loan or credit.
LoanType interface{} `json:"loanType"` // types : Text URL

// RecourseLoan see : https://schema.orghttp://pending.schema.org/recourseLoan
// The only way you get the money back in the event of default is the security. Recourse is where you still have the opportunity to go back to the borrower for the rest of the money.
RecourseLoan bool `json:"recourseLoan"`

// RenegotiableLoan see : https://schema.orghttp://pending.schema.org/renegotiableLoan
