...
Intangible// DefaultValue see : /defaultValue
...
MultipleValues string `json:"multipleValues"`
...
ValueMaxLength string `json:"valueMaxLength"`

// ValueMinLength see : /valueMinLength
// Specifies the minimum allowed range for number of characters in a literal value.
ValueMinLength string `json:"valueMinLength"`
