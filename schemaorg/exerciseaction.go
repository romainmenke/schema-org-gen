...
PlayAction// Diet see : http://health-lifesci.schema.org/diet
...
// A sub property of instrument. The diet used in this action.
ExerciseRelatedDiet string `json:"exerciseRelatedDiet"`
...
SportsActivityLocation string `json:"sportsActivityLocation"`

// SportsEvent see : /sportsEvent
// A sub property of location. The sports event where this action occurred.
SportsEvent string `json:"sportsEvent"`

// SportsTeam see : /sportsTeam
// A sub property of participant. The sports team that participated on this action.
SportsTeam string `json:"sportsTeam"`
